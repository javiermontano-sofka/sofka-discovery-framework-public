...
| Skill | Function |
|---|---|
| `sofka-analytics-engineering` | dbt-style transformation layer design, model cards, testing, semantic layer, medallion architecture consumption tier |
| `sofka-bi-architecture` | Semantic layer design, KPI hierarchies, dashboard architecture, self-service analytics, embedded analytics |
| `sofka-data-science-architecture` | ML pipelines, model registry, feature store, MLOps, drift monitoring, responsible AI |
| `sofka-data-mesh-strategy` | Domain ownership, self-serve data platform, federated governance, data products as first-class citizens |
