...
- Design agent sofka-observability: trace logging, decision auditing, cost tracking

## Assigned Skills

| Skill | Function |
|---|---|
| `sofka-data-science-architecture` | Agent infrastructure, LLM serving, embedding pipelines |
| `sofka-software-architecture` | Agent system design patterns, state management, error handling |
| `sofka-api-architecture` | Tool API design for agents, function calling schemas |
| `sofka-observability` | Agent trace logging, decision auditing, performance monitoring |
| `sofka-security-architecture` | Agent guardrails, permission boundaries, prompt injection defense |
