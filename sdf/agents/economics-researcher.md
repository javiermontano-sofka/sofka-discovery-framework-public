...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates economic feasibility of technical proposals |
| `sofka-cost-estimation` | Evidence-based cost and effort estimation |
| `sofka-finops` | Cloud and infrastructure cost modeling |
| `sofka-commercial-model` | Business model and commercial feasibility |
| `sofka-multidimensional-feasibility` | Economic cross-dimensional validation |
