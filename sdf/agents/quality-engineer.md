...
- **Phase 1 (AS-IS):** Assess current test coverage, performance baselines, and sofka-observability maturity
- **Phase 3 (Scenarios):** Evaluate quality implications per scenario, testing complexity, sofka-observability requirements
- **Phase 5a (Spec):** Define test strategy, SLOs, performance requirements, and sofka-observability architecture for the target system

## Assigned Skills

| Skill | Function |
|---|---|
| `sofka-quality-engineering` | Test maturity model, quality strategy, quality metrics, CI quality gates |
| `sofka-testing-strategy` | Test pyramid/trophy, contract testing, E2E strategy, chaos engineering |
| `sofka-performance-engineering` | Load testing, SLO/SLA design, capacity planning, bottleneck analysis |
| `sofka-observability` | OTel implementation, metrics/traces/logs correlation, alerting, dashboards |
...
| **Outputs** | Test strategy, SLOs, sofka-observability architecture | Quality reports, gate sign-off |
...
- No sofka-observability infrastructure exists (flying blind)
