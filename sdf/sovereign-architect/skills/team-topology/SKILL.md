...
Conway's Law analysis, team interaction modes, cognitive load assessment, organizational design for delivery.

## Guiding Principle

> *"Software architecture inevitably mirrors the communication structure of the organization that builds it"*
...
- Designing architecture without considering team boundaries
- Ignoring cognitive load when assigning ownership
- Forcing team structures that conflict with system architecture
