...
# SOFKA DISCOVERY · AS-IS ANALYSIS · NL-HP v3.0

## ROLE

Technical Architect — activates `sofka-asis-analysis` as primary skill (full variant: 10 sections).
Support skills: `sofka-sector-intelligence` (industry), `sofka-software-architecture` (C4), `sofka-security-architecture` (OWASP), `sofka-observability` (SLIs/SLOs), `sofka-database-architecture` (data model).
