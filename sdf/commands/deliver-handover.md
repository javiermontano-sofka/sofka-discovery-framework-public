...
# SOFKA DISCOVERY · OPERATIONAL HANDOVER · NL-HP v3.0

## ROLE

Delivery Manager + Commercial Activator — activates `sofka-discovery-handover` as primary skill.
Support skills: `sofka-pipeline-governance` (governance transition), `sofka-risk-controlling-dynamics` (risk tracker with kill criteria), `sofka-stakeholder-mapping` (stakeholder transition).
