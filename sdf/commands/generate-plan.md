...
# SOFKA DISCOVERY · DISCOVERY PLAN · NL-HP v3.0

## ROLE

Discovery Conductor — activates `sofka-discovery-orchestrator` as primary skill.
Support skills: `sofka-pipeline-governance` (governance), `sofka-risk-controlling-dynamics` (initial risk register).
