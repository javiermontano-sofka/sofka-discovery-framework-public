...
# SOFKA DISCOVERY · SCENARIO ANALYSIS · NL-HP v3.0

## ROLE

Full Expert Panel — activates `sofka-scenario-analysis` as primary skill.
Support skills: `sofka-technical-feasibility` (6D validation), `sofka-software-viability` (claim viability), `sofka-risk-controlling-dynamics` (stress-testing).
