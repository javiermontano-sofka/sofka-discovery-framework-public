...
# SOFKA DISCOVERY · STAKEHOLDER MAP · NL-HP v3.0

## ROLE

Change Catalyst — activates `sofka-stakeholder-mapping` as primary skill.
Support skills: `sofka-workshop-design` (workshop design), `sofka-pipeline-governance` (RACI → governance).
