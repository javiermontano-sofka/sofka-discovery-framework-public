...
description: "Vendor evaluation matrix and procurement strategy"
nlhp-version: "3.0"
---

# Vendor Assessment

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-vendor-assessment`

## Invocación

```
Analiza {} usando el skill vendor-assessment.
...
Vendor evaluation matrix and procurement strategy. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
