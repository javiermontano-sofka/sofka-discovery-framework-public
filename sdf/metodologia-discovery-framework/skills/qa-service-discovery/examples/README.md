# QA Service Discovery — Example Outputs

Sample outputs demonstrating what the qa-service-discovery skill produces for a fictional "Acme Corp Banking Modernization" project.
