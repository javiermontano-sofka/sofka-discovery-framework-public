...
Todo entregable generado por Sofka SAGE sigue el estándar Markdown-Excellence, que prioriza densidad informativa y navegabilidad.
...
## Branding Sofka (Design System v5)

### Paleta de colores

| Token | Valor | Uso |
|-------|-------|-----|
| `--sofka-primary` | `#FF7E08` | Color principal (naranja Sofka) |
| `--sofka-dark` | `#1A1A2E` | Fondos oscuros, headers |
| `--sofka-success` | `#FFD700` | Estados de éxito (dorado) |
| `--sofka-danger` | `#FF4444` | Errores, bloqueos |
| `--sofka-warning` | `#FFA500` | Advertencias |
| `--sofka-info` | `#4A90D9` | Información, contexto |

> **REGLA CRÍTICA:** NUNCA usar verde para estados de éxito. El éxito en Sofka es dorado (`#FFD700`).
...
| Branding | Header con logo Sofka, footer con disclaimer |
...
- `08_Pitch_Ejecutivo_Bancoomeva_{Aprobado}.html`
