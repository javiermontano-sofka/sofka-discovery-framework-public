...
> Referencia completa del sistema de diseño para outputs HTML del ecosistema SAGE.
> Todos los valores aquí son canónicos. Si un output HTML contradice este archivo, el output está mal.
> Actualizado: 2026-03-14 | Autor: Equipo PreSales Sofka.
...
|-------|-------|-----|-------|
| `--orange` | `#FF7E08` | Acción, CTA, acento, links hover | Primary action |
| `--gold` | `#FFD700` | Éxito, logro, completado, highlight | **NUNCA verde para éxito** |
...
| `--orange-bright` | `#FF9E42` | Hover states, secondary accent |
...
SIEMPRE usar #FFD700 (gold) para éxito, logro, completado, aprobado.
```
...
1. **NUNCA** verde como indicador de éxito → usar gold (#FFD700)
2. **NUNCA** mezclar branding Sofka con MetodologIA
