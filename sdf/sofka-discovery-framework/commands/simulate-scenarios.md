...
# SOFKA DISCOVERY · MONTE CARLO SCENARIO SIMULATION · NL-HP v3.0
...
Support skills: `sofka-cost-estimation` (base estimates and calibration), `sofka-multidimensional-feasibility` (cross-dimensional risk inputs), `sofka-technical-feasibility` (technical uncertainty quantification).
