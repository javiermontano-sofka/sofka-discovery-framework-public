---
description: Convertir skills SAGE MOAT a formatos cross-platform (Cursor, Codex, Gemini, Aider, Windsurf)
user-invocable: true
---

# /sdf:convert-skills

> Convierte skills MOAT de SAGE a formatos compatibles con otras herramientas de AI coding.

## Uso

```
/sdf:convert-skills [target] [skill_dir] [output_dir]
```
