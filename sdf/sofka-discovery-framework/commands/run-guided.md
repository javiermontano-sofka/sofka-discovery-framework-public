...
# SOFKA DISCOVERY · GUIDED FULL PIPELINE · NL-HP v3.0
...
Discovery Conductor — activates `sofka-discovery-orchestrator` as primary skill. Full pipeline: all phases, all gates, all deliverables.
Governance: `sofka-pipeline-governance` (P-01 tracking) + `sofka-risk-controlling-dynamics` (P-02 continuous scanning).
Skills pipeline: sofka-stakeholder-mapping → sofka-asis-analysis → sofka-flow-mapping → sofka-scenario-analysis → sofka-multidimensional-feasibility (Think Tank) → sofka-solution-roadmap + sofka-cost-estimation + sofka-execution-burndown → sofka-commercial-model → sofka-functional-spec → sofka-executive-pitch → findings (10-12) → business-review (13) → ai-opportunities (14) → sofka-discovery-handover (LAST).
HDD: sofka-hypothesis-driven-development transversal (scenarios→roadmap→pitch).
Vigilance: sofka-technology-vigilance feeds Think Tank and scenarios.
...
2. Skill composition per phase:
   - Phase 0: sofka-stakeholder-mapping, sofka-workshop-design
   - Phase 1: sofka-asis-analysis, sofka-sector-intelligence
   - Phase 2: sofka-flow-mapping
   - Phase 3: sofka-scenario-analysis
   - Phase 3b: sofka-multidimensional-feasibility (Think Tank of 7 Sages), sofka-technical-feasibility, sofka-software-viability
   - Phase 4: sofka-solution-roadmap, sofka-cost-estimation, sofka-execution-burndown, sofka-hypothesis-driven-development
   - Phase 4b: sofka-commercial-model
   - Phase 5a: sofka-functional-spec
   - Phase 5b: sofka-executive-pitch
   ...
   - Phase 6: sofka-discovery-handover (LAST — after all findings and recommendations)
...
Council of Seven Sages: sofka-research-scientist, sofka-data-scientist, sofka-systems-theorist, sofka-technology-scout, sofka-hardware-systems-engineer, sofka-integration-researcher, sofka-economics-researcher.
