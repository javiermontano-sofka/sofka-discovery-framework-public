...
# SOFKA DISCOVERY · AUTONOMOUS FULL PIPELINE · NL-HP v3.0
...
Discovery Conductor — activates `sofka-discovery-orchestrator` as primary skill. Unattended mode.
...
5. **Industry identification**: Activate `sofka-sector-intelligence` with inferred sector lens.
