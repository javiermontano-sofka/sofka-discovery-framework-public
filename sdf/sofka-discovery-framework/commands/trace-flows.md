...
# SOFKA DISCOVERY · FLOW MAPPING · NL-HP v3.0

## ROLE

Domain Analyst — activates `sofka-flow-mapping` as primary skill.
Support skills: `sofka-api-architecture` (integrations), `sofka-event-architecture` (event catalog).
