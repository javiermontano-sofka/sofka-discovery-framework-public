...
# SOFKA DISCOVERY · MATURITY BENCHMARK · NL-HP v3.0
...
Support skills: `sofka-multidimensional-feasibility` (cross-dimensional analysis), `sofka-technical-feasibility` (technical capability assessment), `sofka-cost-estimation` (improvement investment estimation).
