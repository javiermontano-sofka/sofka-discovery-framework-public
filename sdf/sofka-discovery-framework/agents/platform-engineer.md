...
| Skill | Function |
|---|---|
| `sofka-cloud-native-architecture` | Containers, service mesh, serverless, FinOps, Kubernetes patterns |
| `sofka-cloud-migration` | 7R strategy, migration factory, wave planning, cutover design |
| `sofka-api-architecture` | REST/GraphQL/gRPC design, API contracts, versioning, governance lifecycle |
| `sofka-event-architecture` | Event sourcing, CQRS, streaming platforms, event catalog, schema registry |
| `sofka-infrastructure-architecture` | IaC, networking design, compute/storage, HA/DR, cloud landing zones, cost optimization |
...
| **Service Mesh** | No mesh | Sidecar proxies on critical paths | Full mesh, mTLS, sofka-observability, traffic management |
