...
| Skill | Function |
|---|---|
| `sofka-data-science-architecture` | ML pipeline design, model registry, feature store, MLOps maturity |
| `sofka-analytics-engineering` | Feature engineering pipelines, data preparation for ML |
| `sofka-performance-engineering` | AI inference optimization, GPU utilization, model serving performance |
| `sofka-cloud-native-architecture` | AI infrastructure on cloud (SageMaker, Vertex AI, Azure ML) |
| `sofka-scenario-analysis` | AI scenario evaluation, build-vs-buy for AI capabilities |
