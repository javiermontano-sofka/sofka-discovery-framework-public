...
## Activation Triggers
- Keywords: plugin design, plugin architecture, ideation, component design, MOAT planning, plugin creation
- Context: When designing new plugins, guiding ideation-to-architecture pipeline, or orchestrating the IDEATE/PLAN/DESIGN movements
