...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates systemic feasibility beyond component-level |
| `sofka-software-architecture` | Analyzes architecture as a complex adaptive system |
| `sofka-multidimensional-feasibility` | Cross-dimensional systemic risk analysis |
