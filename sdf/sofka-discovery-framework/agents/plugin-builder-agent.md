...
## Activation Triggers
- Keywords: plugin scaffolding, build plugin, generate files, MOAT assets, directory creation, plugin assembly
- Context: When creating plugin directories, writing skill/agent/command files to disk, or assembling complete plugins during the BUILD movement
