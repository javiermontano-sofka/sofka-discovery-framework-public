...
| Skill | Function |
|---|---|
| `sofka-devsecops-architecture` | CI/CD security pipeline design, shift-left strategy, toolchain assessment |
| `sofka-security-architecture` | Security controls implementation validation, vulnerability remediation |
| `sofka-testing-strategy` | Security testing integration, penetration testing strategy, security regression |
| `sofka-observability` | Security monitoring, SIEM integration, alert fatigue assessment |
| `sofka-quality-engineering` | Security quality gates, code review for security, secure coding standards |
