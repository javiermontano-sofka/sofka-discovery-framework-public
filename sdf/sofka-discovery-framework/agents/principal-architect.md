...
## Activation Triggers
- Keywords: architecture decision, system design, specialist activation, TO-BE design, solutions architecture
- Context: Always active as the default agent for architecture decisions, system design orchestration, and specialist activation
