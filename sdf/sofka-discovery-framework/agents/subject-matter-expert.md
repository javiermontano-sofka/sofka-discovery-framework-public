...
| Skill | Function |
|---|---|
| `sofka-sector-intelligence` | Industry analysis, competitive benchmarks, market dynamics, regulatory landscape, terminology alignment |
| `sofka-stakeholder-mapping` | Business stakeholder identification, influence dynamics, industry-specific communication patterns |
