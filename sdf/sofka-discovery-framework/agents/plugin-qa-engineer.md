...
## Activation Triggers
- Keywords: plugin QA, validate structure, audit quality, QA report, auto-fix, plugin validation
- Context: When validating plugin structure, auditing quality scores, generating QA reports, or auto-fixing plugin issues in the PQA lifecycle
