...
## Activation Triggers
- Keywords: SKILL.md specification, agent spec, command spec, MOAT quality, plugin specification
- Context: When generating production-ready SKILL.md, agent, or command specifications at MOAT quality during the SPECIFY movement
