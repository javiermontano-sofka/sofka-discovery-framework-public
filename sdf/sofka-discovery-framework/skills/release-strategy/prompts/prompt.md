...
description: "Release management, DORA metrics, and deployment automation"
nlhp-version: "3.0"
---

# Release Strategy

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-release-strategy`

## Invocación

```
Analiza {} usando el skill release-strategy.
...
Release management, DORA metrics, and deployment automation. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
