---
id: staff-augmentation-discovery
title: "Staff Augmentation Discovery"
description: "Team gap analysis and augmentation strategy"
nlhp-version: "3.0"
---

# Staff Augmentation Discovery

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-staff-augmentation-discovery`

## Invocación

```
Analiza {} usando el skill staff-augmentation-discovery.
...
Team gap analysis and augmentation strategy. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
