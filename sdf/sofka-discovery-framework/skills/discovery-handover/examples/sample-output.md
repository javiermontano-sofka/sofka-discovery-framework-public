...
- [x] Repositorio GitHub (org MetodologIA) — creado, permisos pendientes
...
| Steering Committee | Mensual (primer martes) | Sponsors Acme + PMO MetodologIA | Go/no-go, budget, riesgos |
...
| Team attrition | >40% turnover (> 3 de 8) | Pause + re-staff | HR MetodologIA + Felipe Ríos |
...
---
**Autor:** Javier Montaño | **Generado por:** metodologia-discovery-handover v6.0
