...
done > /tmp/sage-deps.txt

case "$FORMAT" in
  mermaid)
    echo "graph TD"
    echo "  %% SAGE Skill Dependency Graph"
    ...
    echo ""
    echo "  %% Styling"
    echo "  classDef core fill:#FF7E08,stroke:#333,color:#fff"
    echo "  classDef phase fill:#EFEAE4,stroke:#FF7E08"
