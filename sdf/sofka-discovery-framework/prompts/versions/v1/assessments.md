# Prompts de Assessment — Sofka SAGE
...
## 1. Architecture Deep-Dive · `/sdf:assess-architecture`

```
# Architecture Deep-Dive · Sofka SAGE
## ROL
...
## 2. Data Landscape · `/sdf:assess-data`

```
# Data Landscape · Sofka SAGE
## ROL
...
## 3. Cloud Readiness · `/sdf:assess-cloud`

```
# Cloud Readiness · Sofka SAGE
## ROL
...
## 4. Security Posture · `/sdf:assess-security`

```
# Security Posture · Sofka SAGE
## ROL
...
## 5. Change Readiness · `/sdf:assess-change`

```
# Change Readiness · Sofka SAGE
## ROL
