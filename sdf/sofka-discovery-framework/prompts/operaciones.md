# Prompts de Operaciones — Sofka SAGE
...
## 1. Rescue Stalled · `/sdf:rescue-stalled`

```
# Rescue Stalled · Sofka SAGE
## ROL
...
7. ADVERTENCIA: Si no hay ningún entregable previo, no ejecutar rescue —
   redirigir a /sdf:run-auto y documentar la recomendación.
...
- Sin entregables previos → NO ejecutar rescue. Redirigir explícitamente a /sdf:run-auto.
...
## 2. Audit Quality · `/sdf:audit-quality`

```
# Audit Quality · Sofka SAGE
## ROL
...
subjetivas — para determinar si los entregables cumplen los estándares del Sofka SAGE
...
## 3. Improve Deliverables · `/sdf:improve-deliverables`

```
# Improve Deliverables · Sofka SAGE
## ROL
...
- NUNCA reescribir un entregable completo desde cero — solo si está corrupto
  o tiene >70% de contenido incorrecto, y en ese caso usar /sdf:rescue-stalled.
...
## 4. Simulate What-If · `/sdf:simulate-scenarios`

```
# Simulate What-If · Sofka SAGE
## ROL
...
## 5. Benchmark Maturity · `/sdf:benchmark-maturity`

```
# Benchmark Maturity · Sofka SAGE
## ROL
