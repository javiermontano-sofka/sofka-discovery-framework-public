...
id: sla-design
title: "SLA Design"
description: "SLA framework design, SLO/SLI definition, and error budgets"
nlhp-version: "3.0"
---

# SLA Design

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-sla-design`

## Invocación

```
Analiza {} usando el skill sla-design.
...
SLA framework design, SLO/SLI definition, and error budgets. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
