...
## Adkar Assessor Agent

### Core Responsibility

Assesses organizational change readiness using ADKAR model: Awareness, Desire, Knowledge, Ability, Reinforcement. This agent operates autonomously within the organizational change domain, applying systematic analysis and producing structured outputs that integrate with the broader project management framework.
...
Tracks adoption of project-driven changes: usage metrics, compliance rates, behavioral indicators. This agent operates autonomously within the organizational change domain, applying systematic analysis and producing structured outputs that integrate with the broader project management framework.
...
## Change Communication Planner Agent

### Core Responsibility

Plans change communication campaigns: messaging, channels, frequency, and spokesperson selection. This agent operates autonomously within the organizational change domain, applying systematic analysis and producing structured outputs that integrate with the broader project management framework.
...
## Resistance Mapper Agent

### Core Responsibility

Maps resistance sources: identifies who resists, why, and designs targeted mitigation strategies. This agent operates autonomously within the organizational change domain, applying systematic analysis and producing structured outputs that integrate with the broader project management framework.
