...
- [ ] Output references the skill's primary domain (mentions 'Roadmap' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Roadmap, Execution Planning, Sprint-Level Delivery Architecture
...
- Output fabricates Execution Planning not supported by source data
...
- Primary concepts: Roadmap, Execution Planning, Sprint-Level Delivery Architecture

Generates, Principio Rector, Filosofia
- Expected sections: Roadmap & PoC Execution Planning: Sprint-Level Delivery Architecture, Principio Rector, Filosofia de Execution Planning
- Skill kind: generic
