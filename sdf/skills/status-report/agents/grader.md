...
---
# Grader — status-report

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Status Report Generation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Status Report Generation, Generates, Adapts)
...
- Output fabricates Generates not supported by source data
...
- Primary concepts: Status Report Generation, Generates, Adapts, Principio Rector, Assumptions
- Expected sections: Status Report Generation, Principio Rector, Assumptions & Limits
- Skill kind: generic
