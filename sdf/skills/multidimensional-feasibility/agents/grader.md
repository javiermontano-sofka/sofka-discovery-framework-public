...
---
# Grader — multidimensional-feasibility

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Multidimensional Feasibility' or related domain terminology)
- [ ] Output contains the expected `## Think Tank Deliberation Protocol` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Multidimensional Feasibility, Think Tank, Sages
...
- Output fabricates Think Tank not supported by source data
...
- Primary concepts: Multidimensional Feasibility, Think Tank, Sages

Validates, Guiding Principle, Every
- Expected sections: Multidimensional Feasibility: Think Tank of 7 Sages, Guiding Principle, Think Tank Philosophy
- Skill kind: generic
