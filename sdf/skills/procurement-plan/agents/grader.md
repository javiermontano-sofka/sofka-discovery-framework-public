...
---
# Grader — procurement-plan

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Procurement Planning' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Procurement Planning, Make-or-Buy Analysis, Produces)
...
- Output fabricates Make-or-Buy Analysis not supported by source data
...
- Primary concepts: Procurement Planning, Make-or-Buy Analysis, Produces, CPFF, Principio Rector
Cada
- Expected sections: Procurement Planning & Make-or-Buy Analysis, Principio Rector, Assumptions & Limits
- Skill kind: plan
