...
---
# Grader — less-nexus-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'LeSS' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., LeSS, Nexus Multi-Team Scaling, Designs)
...
- Output fabricates Nexus Multi-Team Scaling not supported by source data
...
- Primary concepts: LeSS, Nexus Multi-Team Scaling, Designs, Scrum, Large-Scale Scrum
- Expected sections: LeSS / Nexus Multi-Team Scaling, Principio Rector, Assumptions & Limits
