...
- [ ] Output references the skill's primary domain (mentions 'Sofka HTML Brand' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Sofka HTML Brand, Document Generator
...
- Output fabricates Document Generator

Generate not supported by source data
...
- Primary concepts: Sofka HTML Brand, Document Generator

Generate, HTML, Sofka Design System, Dark Authority
- Expected sections: Sofka HTML Brand — Document Generator, Principio Rector, Filosofía de Brand HTML
- Skill kind: generic
