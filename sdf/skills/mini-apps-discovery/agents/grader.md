...
---
# Grader — mini-apps-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Mini Apps' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Mini Apps, Low-Code Discovery, Citizen Development Readiness Assessment
...
- Primary concepts: Mini Apps, Low-Code Discovery, Citizen Development Readiness Assessment

Generates, Low-Code, Produces
- Expected sections: Mini Apps & Low-Code Discovery — Citizen Development Readiness Assessment, Principio Rector, Inputs
