...
---
# Grader — engagement-strategy

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Stakeholder Engagement Strategy' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Stakeholder Engagement Strategy, Designs, Includes)
...
- Output fabricates Designs not supported by source data
...
- Primary concepts: Stakeholder Engagement Strategy, Designs, Includes, Principio Rector, Cada
- Expected sections: Stakeholder Engagement Strategy, Principio Rector, Assumptions & Limits
- Skill kind: strategy
