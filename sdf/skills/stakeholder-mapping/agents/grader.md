...
---
# Grader — stakeholder-mapping

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Stakeholder Mapping' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Stakeholder Mapping, Analysis, Engagement)
...
- Output fabricates Analysis not supported by source data
...
- Primary concepts: Stakeholder Mapping, Analysis, Engagement, Change Readiness

Stakeholder, Produces
- Expected sections: Stakeholder Mapping: Analysis, Engagement & Change Readiness, Principio Rector, Filosofía de Mapeo de Stakeholders
- Skill kind: generic
