...
---
# Grader — change-readiness-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Change Readiness Assessment

Generates' or related domain terminology)
- [ ] Output contains the expected `## Assumptions & Limits` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Change Readiness Assessment

Generates, ADKAR-based, Guiding Principle)
...
- Output fabricates ADKAR-based not supported by source data
...
- Primary concepts: Change Readiness Assessment

Generates, ADKAR-based, Guiding Principle, Resistance, Every
- Expected sections: Change Readiness Assessment, Guiding Principle, Inputs
