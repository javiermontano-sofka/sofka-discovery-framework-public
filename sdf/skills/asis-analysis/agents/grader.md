...
---
# Grader — asis-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'AS-IS Analysis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., AS-IS Analysis, Universal Current-State Assessment

Generates, MetodologIA)
...
- Output fabricates Universal Current-State Assessment
...
- Primary concepts: AS-IS Analysis, Universal Current-State Assessment

Generates, MetodologIA, Management, Data-AI
- Expected sections: AS-IS Analysis — Universal Current-State Assessment, Principio Rector, Inputs
- Skill kind: generic
