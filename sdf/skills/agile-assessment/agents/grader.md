...
---
# Grader — agile-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Agile Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Agile Maturity Assessment, Assesses, Produces)
...
- Primary concepts: Agile Maturity Assessment, Assesses, Produces, Principio Rector, Assumptions
- Expected sections: Agile Maturity Assessment, Principio Rector, Assumptions & Limits
