...
---
# Grader — conflict-resolution

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Stakeholder Conflict Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Stakeholder Conflict Management, Provides, Identifies)
...
- Output fabricates Provides not supported by source data
...
- Primary concepts: Stakeholder Conflict Management, Provides, Identifies, Principio Rector, Assumptions
- Expected sections: Stakeholder Conflict Management, Principio Rector, Assumptions & Limits
- Skill kind: generic
