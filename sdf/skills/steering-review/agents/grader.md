...
---
# Grader — steering-review

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Steering Review' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Steering Review, Advisor Committee, Phase)
...
- Output fabricates Advisor Committee not supported by source data
...
- Primary concepts: Steering Review, Advisor Committee, Phase, Go/No-Go, Each
- Expected sections: Steering Review (7-Advisor Committee), Principio Rector, Assumptions & Limits
- Skill kind: review
