...
## Automation Rule Builder Agent

### Core Responsibility

Builds automation rules for status updates and notifications. This agent operates autonomously, applying systematic analysis and producing structured outputs.
...
Designs Jira/Azure DevOps board layouts. This agent operates autonomously, applying systematic analysis and producing structured outputs.
...
### Reporting Dashboard Creator


## Reporting Dashboard Creator Agent

### Core Responsibility

Creates reporting dashboards with JQL/queries. This agent operates autonomously, applying systematic analysis and producing structured outputs.
...
## Workflow Configurer Agent

### Core Responsibility

Configures issue workflows with status transitions and rules. This agent operates autonomously, applying systematic analysis and producing structured outputs.
