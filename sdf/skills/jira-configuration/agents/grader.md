...
---
# Grader — jira-configuration

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Jira' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Jira, Azure DevOps Configuration, Designs)
...
- Output fabricates Azure DevOps Configuration not supported by source data
...
- Primary concepts: Jira, Azure DevOps Configuration, Designs, Azure DevOps, Ensures
- Expected sections: Jira / Azure DevOps Configuration, Principio Rector, Assumptions & Limits
- Skill kind: generic
