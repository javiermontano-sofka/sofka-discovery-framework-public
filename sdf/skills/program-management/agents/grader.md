...
---
# Grader — program-management

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Program Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Program Management, Coordination, Coordinates)
...
- Output fabricates Coordination not supported by source data
...
- Primary concepts: Program Management, Coordination, Coordinates, Manages, Principio Rector
- Expected sections: Program Management & Coordination, Principio Rector, Assumptions & Limits
- Skill kind: generic
