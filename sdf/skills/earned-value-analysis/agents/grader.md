...
---
# Grader — earned-value-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Earned Value Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Earned Value Management, Analysis

Performs Earned Value Management, TCPI)
...
- Output fabricates Analysis

Performs Earned Value Management not supported by source data
...
- Primary concepts: Earned Value Management, Analysis

Performs Earned Value Management, TCPI, Produces, Principio Rector

EVM
- Expected sections: Earned Value Management (EVM) Analysis, Principio Rector, Assumptions & Limits
- Skill kind: generic
