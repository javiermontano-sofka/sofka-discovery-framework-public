...
---
# Grader — team-performance

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Team Performance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Team Performance, Health Tracking, Tracks)
...
- Output fabricates Health Tracking not supported by source data
...
- Primary concepts: Team Performance, Health Tracking, Tracks, Monitors, Principio Rector
- Expected sections: Team Performance & Health Tracking, Principio Rector, Assumptions & Limits
- Skill kind: generic
