...
---
# Grader — adoption-strategy

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Adoption Strategy

Designs' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Adoption Strategy

Designs, KPIs, Guiding Principle)
...
- Output fabricates KPIs not supported by source data
...
- Primary concepts: Adoption Strategy

Designs, KPIs, Guiding Principle, Adoption, Every
- Expected sections: Adoption Strategy, Guiding Principle, Inputs
- Skill kind: strategy
