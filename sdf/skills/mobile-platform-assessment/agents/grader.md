...
---
# Grader — mobile-platform-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Mobile Platform Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Mobile Platform Assessment, Strategy, Health)
...
- Primary concepts: Mobile Platform Assessment, Strategy, Health, Remediation

Mobile, Guiding Principle
- Expected sections: Mobile Platform Assessment: Strategy, Health & Remediation, Guiding Principle, Unified Philosophy
