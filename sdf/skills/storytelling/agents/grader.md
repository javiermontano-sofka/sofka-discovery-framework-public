...
- [ ] Output references the skill's primary domain (mentions 'Storytelling' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Storytelling, Narrative Arc, Transformation Stories
...
- Output fabricates Narrative Arc not supported by source data
...
- Primary concepts: Storytelling, Narrative Arc, Transformation Stories

Designs, Owns, Guiding Principle
- Expected sections: Storytelling — Narrative Arc & Transformation Stories, Guiding Principle, Narrative Philosophy
- Skill kind: generic
