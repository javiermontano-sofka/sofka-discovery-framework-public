...
---
# Grader — compliance-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Compliance Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Compliance Assessment, Regulatory, Standards Gap Analysis
...
- Output fabricates Regulatory not supported by source data
...
- Primary concepts: Compliance Assessment, Regulatory, Standards Gap Analysis

Compliance, Evalua, GDPR
- Expected sections: Compliance Assessment: Regulatory & Standards Gap Analysis, TL;DR, Inputs
