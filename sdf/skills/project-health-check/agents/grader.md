...
---
# Grader — project-health-check

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Project Health Check Scorecard' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Project Health Check Scorecard, Conducts, Produces)
...
- Output fabricates Conducts not supported by source data
...
- Primary concepts: Project Health Check Scorecard, Conducts, Produces, Red/Amber/Blue, Principio Rector
- Expected sections: Project Health Check Scorecard, Principio Rector, Assumptions & Limits
- Skill kind: generic
