...
---
# Grader — architecture-tobe

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'TO-BE Architecture Design
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., TO-BE Architecture Design

Designs, Produces, ADRs)
...
- Primary concepts: TO-BE Architecture Design

Designs, Produces, ADRs, Strangler Fig, Principio Rector
- Expected sections: TO-BE Architecture Design, Principio Rector, Filosofía de Arquitectura Objetivo
- Skill kind: generic
