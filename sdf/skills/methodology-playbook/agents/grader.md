...
---
# Grader — methodology-playbook

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Methodology Playbook' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Methodology Playbook, Core Phase, Definition)
...
- Output fabricates Core Phase not supported by source data
...
- Primary concepts: Methodology Playbook, Core Phase, Definition, Done, Transforms
- Expected sections: Methodology Playbook, Principio Rector, Assumptions & Limits
- Skill kind: playbook
