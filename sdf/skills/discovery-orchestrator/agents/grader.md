...
---
# Grader — discovery-orchestrator

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'MetodologIA Discovery Orchestrator

The' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., MetodologIA Discovery Orchestrator

The, MetodologIA, Coordinates)
...
- Output fabricates MetodologIA not supported by source data
...
- Primary concepts: MetodologIA Discovery Orchestrator

The, MetodologIA, Coordinates, TIPO_SERVICIO, Service Type Parameter
- Expected sections: MetodologIA Discovery Orchestrator, Service Type Parameter, Auto-Detection Rules (Priority Order)
