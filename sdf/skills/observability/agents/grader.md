...
- [ ] Output references the skill's primary domain (mentions 'Observability Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Observability Architecture, Instrumentation, Detection)
...
- Output fabricates Instrumentation not supported by source data
...
- Primary concepts: Observability Architecture, Instrumentation, Detection, Response

Observability, Principio Rector
- Expected sections: Observability Architecture: Instrumentation, Detection & Response, Principio Rector, Filosofía de Observability
- Skill kind: generic
