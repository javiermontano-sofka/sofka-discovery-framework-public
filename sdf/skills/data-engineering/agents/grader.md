...
---
# Grader — data-engineering

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Data Engineering' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Engineering, Pipeline Architecture, Data Platform Design
...
- Output fabricates Pipeline Architecture not supported by source data
...
- Primary concepts: Data Engineering, Pipeline Architecture, Data Platform Design

Data, Principio Rector, Data
- Expected sections: Data Engineering: Pipeline Architecture & Data Platform Design, Principio Rector, Filosofía de Data Engineering
- Skill kind: engine
