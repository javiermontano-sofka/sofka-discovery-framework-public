...
---
# Grader — vendor-cost-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Vendor Cost Analysis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Vendor Cost Analysis, Performs, Produces)
...
- Output fabricates Performs not supported by source data
...
- Primary concepts: Vendor Cost Analysis, Performs, Produces, Principio Rector, NUNCA
- Expected sections: Vendor Cost Analysis & TCO, Principio Rector, Assumptions & Limits
- Skill kind: generic
