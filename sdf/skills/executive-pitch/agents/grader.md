...
---
# Grader — executive-pitch

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Executive Pitch' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Executive Pitch, Business Case

Generates C-level, Uses Problem-Agitate-Solve)
...
- Output fabricates Business Case

Generates C-level not supported by source data
...
- Primary concepts: Executive Pitch, Business Case

Generates C-level, Uses Problem-Agitate-Solve, Principio Rector, C-level
- Expected sections: Executive Pitch & Business Case, Principio Rector, Filosofía de Persuasión Ejecutiva
- Skill kind: generic
