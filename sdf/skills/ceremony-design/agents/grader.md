...
---
# Grader — ceremony-design

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Ceremony Cadence' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Ceremony Cadence, Facilitation Design, Designs)
...
- Primary concepts: Ceremony Cadence, Facilitation Design, Designs, Adapts, Scrum
- Expected sections: Ceremony Cadence & Facilitation Design, Principio Rector, Assumptions & Limits
- Skill kind: design
