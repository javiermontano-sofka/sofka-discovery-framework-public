...
---
# Grader — functional-toolbelt

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Functional Toolbelt

Mental' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Functional Toolbelt

Mental, Principio Rector, Event)
...
- Output fabricates Principio Rector not supported by source data
...
- Primary concepts: Functional Toolbelt

Mental, Principio Rector, Event, Acceptance, Filosofía
- Expected sections: Functional Toolbelt, Principio Rector, Filosofía del Toolbelt
- Skill kind: generic
