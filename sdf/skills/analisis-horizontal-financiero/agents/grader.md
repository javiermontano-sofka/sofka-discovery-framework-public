...
---
# Grader — analisis-horizontal-financiero

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Análisis Horizontal' or related domain terminology)
- [ ] Output contains the expected `## Quality Criteria` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Análisis Horizontal, Estados Financieros, Propósito
...
- Output fabricates Estados Financieros not supported by source data
...
- Primary concepts: Análisis Horizontal, Estados Financieros, Propósito

Este, Year-over-Year, Produce
- Expected sections: Análisis Horizontal de Estados Financieros, Propósito, Flujo de Trabajo
- Skill kind: generic
