...
---
# Grader — risk-controlling-dynamics

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Risk' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk, Controlling Dynamics, Anxious Controller Who Makes Everything Reliable
...
- Output fabricates Controlling Dynamics not supported by source data
...
- Primary concepts: Risk, Controlling Dynamics, Anxious Controller Who Makes Everything Reliable

Proactive, Principio Rector, ANTES
- Expected sections: Risk & Controlling Dynamics: The Anxious Controller Who Makes Everything Reliable, Principio Rector, Filosofía del Controller Ansioso
- Skill kind: generic
