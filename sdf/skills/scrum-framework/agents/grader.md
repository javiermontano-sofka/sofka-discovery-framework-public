...
---
# Grader — scrum-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Scrum Framework Implementation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Scrum Framework Implementation, Designs, Scrum)
...
- Primary concepts: Scrum Framework Implementation, Designs, Scrum, Definition, Done
- Expected sections: Scrum Framework Implementation, Principio Rector, Assumptions & Limits
