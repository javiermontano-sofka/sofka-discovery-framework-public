...
---
# Grader — project-selection

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Project Selection' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Project Selection, Go/No-Go Gates, Evaluates)
...
- Output fabricates Go/No-Go Gates not supported by source data
...
- Primary concepts: Project Selection, Go/No-Go Gates, Evaluates, Assesses, Principio Rector
Decir
- Expected sections: Project Selection & Go/No-Go Gates, Principio Rector, Assumptions & Limits
- Skill kind: generic
