...
---
# Grader — portfolio-dashboard

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Portfolio-Level Dashboard' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Portfolio-Level Dashboard, Reporting, Produces)
...
- Output fabricates Reporting not supported by source data
...
- Primary concepts: Portfolio-Level Dashboard, Reporting, Produces, Provides, Principio Rector
- Expected sections: Portfolio-Level Dashboard & Reporting, Principio Rector, Assumptions & Limits
- Skill kind: generic
