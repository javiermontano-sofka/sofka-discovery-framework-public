...
---
# Grader — methodology-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Methodology Fit Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Methodology Fit Assessment, Selection, Evaluates)
...
- Output fabricates Selection not supported by source data
...
- Primary concepts: Methodology Fit Assessment, Selection, Evaluates, Scrum, Kanban
- Expected sections: Methodology Fit Assessment & Selection, Principio Rector, Assumptions & Limits
