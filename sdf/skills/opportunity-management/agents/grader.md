...
---
# Grader — opportunity-management

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Opportunity Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Opportunity Management, Positive Risk, Manages)
...
- Output fabricates Positive Risk not supported by source data
...
- Primary concepts: Opportunity Management, Positive Risk, Manages, Identifies, Principio Rector
- Expected sections: Opportunity Management (Positive Risk), Principio Rector, Assumptions & Limits
- Skill kind: generic
