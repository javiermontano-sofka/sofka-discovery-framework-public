...
---
# Grader — risk-response-planning

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Risk Response Planning' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk Response Planning, Develops, Each)
...
- Output fabricates Develops not supported by source data
...
- Primary concepts: Risk Response Planning, Develops, Each, Updates, Principio Rector
Identificar
- Expected sections: Risk Response Planning, Principio Rector, Assumptions & Limits
- Skill kind: plan
