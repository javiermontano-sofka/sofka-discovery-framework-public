...
---
# Grader — benefits-realization-plan

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Benefits Realization Plan' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Benefits Realization Plan, Produces, Defines KPIs)
...
- Primary concepts: Benefits Realization Plan, Produces, Defines KPIs, Principio Rector, KPIs
- Expected sections: Benefits Realization Plan, Principio Rector, Assumptions & Limits
- Skill kind: plan
