...
---
# Grader — data-mesh-strategy

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Data Mesh Strategy
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Mesh Strategy

Generates, Zhamak Dehghani, Produces)
...
- Output fabricates Zhamak Dehghani not supported by source data
...
- Primary concepts: Data Mesh Strategy

Generates, Zhamak Dehghani, Produces, Guiding Principle, Data
- Expected sections: Data Mesh Strategy, Guiding Principle, Inputs
- Skill kind: strategy
