...
---
# Grader — capacity-planning

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Resource Capacity Planning' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Resource Capacity Planning, Demand Forecasting, Analyzes)
...
- Output fabricates Demand Forecasting not supported by source data
...
- Primary concepts: Resource Capacity Planning, Demand Forecasting, Analyzes, Produces, Principio Rector
- Expected sections: Resource Capacity Planning & Demand Forecasting, Principio Rector, Assumptions & Limits
- Skill kind: plan
