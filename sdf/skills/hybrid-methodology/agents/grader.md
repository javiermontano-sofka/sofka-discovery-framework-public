...
---
# Grader — hybrid-methodology

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Hybrid Methodology Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Hybrid Methodology Design, Designs, Maps)
...
- Primary concepts: Hybrid Methodology Design, Designs, Maps, Principio Rector, Assumptions
- Expected sections: Hybrid Methodology Design, Principio Rector, Assumptions & Limits
- Skill kind: generic
