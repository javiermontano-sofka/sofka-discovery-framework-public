...
---
# Grader — budget-tracking

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Budget Tracking' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Budget Tracking, Cost Variance, Monitors)
...
- Output fabricates Cost Variance not supported by source data
...
- Primary concepts: Budget Tracking, Cost Variance, Monitors, Provides, Principio Rector
- Expected sections: Budget Tracking & Cost Variance, Principio Rector, Assumptions & Limits
- Skill kind: generic
