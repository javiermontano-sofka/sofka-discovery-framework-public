...
---
# Grader — change-control-board

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Change Control Board' or related domain terminology)
- [ ] Output contains the expected `## Change Control Board (CCB) Process` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Change Control Board, Process, Establishes)
...
- Output fabricates Process not supported by source data
...
- Primary concepts: Change Control Board, Process, Establishes, Ensures, Principio Rector
- Expected sections: Change Control Board (CCB) Process, Principio Rector, Assumptions & Limits
- Skill kind: generic
