...
---
# Grader — contingency-planning

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Contingency Planning' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Contingency Planning, Reserve Management, Develops)
...
- Output fabricates Reserve Management not supported by source data
...
- Primary concepts: Contingency Planning, Reserve Management, Develops, Calculates, Defines
- Expected sections: Contingency Planning & Reserve Management, Principio Rector, Assumptions & Limits
- Skill kind: plan
