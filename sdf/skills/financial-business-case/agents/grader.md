...
---
# Grader — financial-business-case

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Financial Business Case Analysis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Financial Business Case Analysis, Produces, Quantifies)
...
- Primary concepts: Financial Business Case Analysis, Produces, Quantifies, Provides, Principio Rector
- Expected sections: Financial Business Case Analysis, Principio Rector, Assumptions & Limits
- Skill kind: generic
