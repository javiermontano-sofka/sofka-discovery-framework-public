...
---
# Grader — cloud-service-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cloud Service Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cloud Service Discovery, Cloud Operations Assessment, Roadmap
...
- Primary concepts: Cloud Service Discovery, Cloud Operations Assessment, Roadmap

Genera, Cloud-as-a-Service, DevOps
- Expected sections: Cloud Service Discovery — Cloud Operations Assessment & Roadmap, Principio Rector, Inputs
