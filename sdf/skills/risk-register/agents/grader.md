...
- [ ] Output references the skill's primary domain (mentions 'Risk Register' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk Register, Identification
...
- Output fabricates Identification

Produces not supported by source data
...
- Primary concepts: Risk Register, Identification

Produces, SWOT, Each, Integrates
- Expected sections: Risk Register & Identification, Principio Rector, Assumptions & Limits
- Skill kind: register
