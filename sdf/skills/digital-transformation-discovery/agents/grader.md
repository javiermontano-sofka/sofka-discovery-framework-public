...
---
# Grader — digital-transformation-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Digital Transformation Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Digital Transformation Discovery, Program-Level Assessment, Roadmap
...
- Primary concepts: Digital Transformation Discovery, Program-Level Assessment, Roadmap

Genera, Diseñado, MetodologIA
- Expected sections: Digital Transformation Discovery — Program-Level Assessment & Roadmap, Principio Rector, Inputs
