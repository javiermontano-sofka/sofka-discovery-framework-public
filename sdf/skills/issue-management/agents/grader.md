...
---
# Grader — issue-management

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Issue Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Issue Management, Resolution, Implements)
...
- Output fabricates Resolution not supported by source data
...
- Primary concepts: Issue Management, Resolution, Implements, Establishes, Issues
- Expected sections: Issue Management & Resolution, Principio Rector, Assumptions & Limits
- Skill kind: generic
