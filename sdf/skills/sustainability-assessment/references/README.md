...
---
# references — sustainability-assessment

> Generated placeholder. Replace with skill-specific references.

## Purpose

This directory holds long-form domain knowledge for the `sustainability-assessment` skill.
