...
---
# Grader — sustainability-assessment
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Evaluacion, Sostenibilidad
...
- Output fabricates Sostenibilidad

Evaluacion not supported by source data
...
- Primary concepts: Evaluacion, Sostenibilidad

Evaluacion, Green, Evalua, Estima
- Expected sections: Evaluacion de Sostenibilidad, TL;DR, Inputs
