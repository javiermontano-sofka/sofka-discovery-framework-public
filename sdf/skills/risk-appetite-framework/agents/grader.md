...
---
# Grader — risk-appetite-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Risk Appetite' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk Appetite, Tolerance Framework, Establishes)
...
- Output fabricates Tolerance Framework not supported by source data
...
- Primary concepts: Risk Appetite, Tolerance Framework, Establishes, Ensures, Principio Rector
- Expected sections: Risk Appetite & Tolerance Framework, Principio Rector, Assumptions & Limits
