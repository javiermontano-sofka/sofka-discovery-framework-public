...
- [ ] Output references the skill's primary domain (mentions 'CONOPS' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., CONOPS, Operational Concept, AI-Enabled Systems
...
- Output fabricates Operational Concept not supported by source data
...
- Primary concepts: CONOPS, Operational Concept, AI-Enabled Systems

CONOPS, Aligned, IEEE
- Expected sections: AI CONOPS: Operational Concept for AI-Enabled Systems, Principio Rector, Filosofia de CONOPS para IA
- Skill kind: generic
