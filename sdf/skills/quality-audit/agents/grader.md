...
- [ ] Output references the skill's primary domain (mentions 'Quality Audit' or related domain terminology)
- [ ] Output contains the expected `## Quality Audit & Compliance Verification` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Quality Audit, Compliance Verification, Conducts)
...
- Primary concepts: Quality Audit, Compliance Verification, Conducts, Reviews, Principio Rector
- Expected sections: Quality Audit & Compliance Verification, Principio Rector, Assumptions & Limits
- Skill kind: audit
