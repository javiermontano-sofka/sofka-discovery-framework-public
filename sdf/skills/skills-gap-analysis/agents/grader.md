...
---
# Grader — skills-gap-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Skills Gap Analysis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Skills Gap Analysis, Training Plan, Assesses)
...
- Output fabricates Training Plan not supported by source data
...
- Primary concepts: Skills Gap Analysis, Training Plan, Assesses, Produces, Distinguishes
- Expected sections: Skills Gap Analysis & Training Plan, Principio Rector, Assumptions & Limits
- Skill kind: generic
