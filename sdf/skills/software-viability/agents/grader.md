...
---
# Grader — software-viability

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Service' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Service, Technology Viability, Substance)
...
- Output fabricates Technology Viability not supported by source data
...
- Primary concepts: Service, Technology Viability, Substance, Smoke Validator

Forensic, AI/ML
- Expected sections: Service & Technology Viability: Substance vs Smoke Validator, Principio Rector, Filosofía de Validación de Software
- Skill kind: generic
