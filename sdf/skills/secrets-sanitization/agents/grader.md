...
---
# Grader — secrets-sanitization

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Secrets Sanitization' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Secrets Sanitization, Gate, Scans)
...
- Output fabricates Gate not supported by source data
...
- Primary concepts: Secrets Sanitization, Gate, Scans, Implements Gate, Detects
- Expected sections: Secrets Sanitization (Gate G0), Principio Rector, Assumptions & Limits
- Skill kind: generic
