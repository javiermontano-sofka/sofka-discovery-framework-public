...
---
# Grader — dependency-mapping

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cross-Project Dependency Mapping' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cross-Project Dependency Mapping, Maps, Identifies)
...
- Output fabricates Maps not supported by source data
...
- Primary concepts: Cross-Project Dependency Mapping, Maps, Identifies, Produces, Principio Rector
Las
- Expected sections: Cross-Project Dependency Mapping, Principio Rector, Assumptions & Limits
- Skill kind: generic
