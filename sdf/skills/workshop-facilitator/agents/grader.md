...
---
# Grader — workshop-facilitator

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Workshop Facilitator' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Workshop Facilitator, Collaborative Discovery, Design Techniques
...
- Output fabricates Collaborative Discovery not supported by source data
...
- Primary concepts: Workshop Facilitator, Collaborative Discovery, Design Techniques

Workshop, Covers, Principio Rector
- Expected sections: Workshop Facilitator: Collaborative Discovery & Design Techniques, Principio Rector, Inputs
- Skill kind: generic
