...
---
# Grader — safe-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'SAFe Framework Implementation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., SAFe Framework Implementation, Designs SAFe, Scaled Agile Framework)
...
- Output fabricates Designs SAFe not supported by source data
...
- Primary concepts: SAFe Framework Implementation, Designs SAFe, Scaled Agile Framework, Planning, Kanban
- Expected sections: SAFe Framework Implementation, Principio Rector, Assumptions & Limits
- Skill kind: framework
