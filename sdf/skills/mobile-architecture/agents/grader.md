...
---
# Grader — mobile-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Mobile Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Mobile Architecture, Platform Strategy, Patterns)
...
- Output fabricates Platform Strategy not supported by source data
...
- Primary concepts: Mobile Architecture, Platform Strategy, Patterns, Release Management

Mobile, Principio Rector
- Expected sections: Mobile Architecture: Platform Strategy, Patterns & Release Management, Principio Rector, Filosofía de Arquitectura Mobile
- Skill kind: generic
