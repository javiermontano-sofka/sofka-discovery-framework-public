...
---
# Grader — risk-quantification

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Risk Quantification' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk Quantification, Analysis, Performs)
...
- Primary concepts: Risk Quantification, Analysis, Performs, Monte Carlo, Expected Monetary Value
- Expected sections: Risk Quantification & Analysis, Principio Rector, Assumptions & Limits
- Skill kind: generic
