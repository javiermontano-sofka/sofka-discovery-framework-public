...
---
# Grader — hypothesis-driven-delivery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Hypothesis-Driven Delivery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Hypothesis-Driven Delivery, Applies, Principio Rector
Toda)
...
- Output fabricates Applies not supported by source data
...
- Primary concepts: Hypothesis-Driven Delivery, Applies, Principio Rector
Toda, Invertir, Assumptions
- Expected sections: Hypothesis-Driven Delivery (HDD), Principio Rector, Assumptions & Limits
- Skill kind: generic
