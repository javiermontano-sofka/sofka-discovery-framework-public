...
---
# Grader — budget-baseline

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Budget Baseline' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Budget Baseline, Cost Breakdown, Produces)
...
- Output fabricates Cost Breakdown not supported by source data
...
- Primary concepts: Budget Baseline, Cost Breakdown, Produces, S-curve, Serves
- Expected sections: Budget Baseline & Cost Breakdown, Principio Rector, Assumptions & Limits
- Skill kind: generic
