...
---
# Grader — project-orchestrator

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'PMO-APEX Project Orchestrator' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., PMO-APEX Project Orchestrator, PMO-APEX, Coordinates)
...
- Output fabricates PMO-APEX not supported by source data
...
- Primary concepts: PMO-APEX Project Orchestrator, PMO-APEX, Coordinates, TIPO_PROYECTO, Service Type Parameter
- Expected sections: PMO-APEX Project Orchestrator, Service Type Parameter, Auto-Detection Rules (Priority Order)
- Skill kind: orchestrator
