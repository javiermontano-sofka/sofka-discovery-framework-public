...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Alcance, TIPO_SERVICIO, Data-AI)
...
- Primary concepts: Alcance, TIPO_SERVICIO, Data-AI, Database Architecture, Schema Design
- Expected sections: Database Architecture: Schema Design, Storage Strategy & Data Evolution, Principio Rector, Inputs
- Skill kind: generic
