...
---
# Grader — mobile-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Mobile Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Mobile Assessment, Health, Compliance)
...
- Output fabricates Health not supported by source data
...
- Primary concepts: Mobile Assessment, Health, Compliance, Remediation

Mobile, AS-IS
- Expected sections: Mobile Assessment: App Health, Compliance & Remediation, Principio Rector, Filosofía de Assessment Mobile
