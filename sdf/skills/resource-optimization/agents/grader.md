...
---
# Grader — resource-optimization

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Resource Optimization' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Resource Optimization, What-If Scenarios, Performs)
...
- Output fabricates What-If Scenarios not supported by source data
...
- Primary concepts: Resource Optimization, What-If Scenarios, Performs, Runs, Principio Rector
Resource
- Expected sections: Resource Optimization & What-If Scenarios, Principio Rector, Assumptions & Limits
- Skill kind: generic
