...
---
# Grader — commercial-model

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Commercial Model' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Commercial Model, Value Capture, Deal Structure Strategy
...
- Primary concepts: Commercial Model, Value Capture, Deal Structure Strategy

Identifies, Goes, Produces
- Expected sections: Commercial Model: Value Capture & Deal Structure Strategy, Principio Rector, Filosofía Comercial
- Skill kind: model
