...
---
# Grader — predictive-analytics

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Predictive Analytics' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Predictive Analytics, Project Management, Applies ML-based)
...
- Output fabricates Project Management not supported by source data
...
- Primary concepts: Predictive Analytics, Project Management, Applies ML-based, Monte Carlo, Principio Rector
- Expected sections: Predictive Analytics for Project Management, Principio Rector, Assumptions & Limits
- Skill kind: generic
