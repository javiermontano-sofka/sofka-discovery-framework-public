...
---
# Grader — spotify-model

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Spotify Model' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Spotify Model, Squads, Tribes)
...
- Primary concepts: Spotify Model, Squads, Tribes, Chapters, Guilds
- Expected sections: Spotify Model: Squads, Tribes, Chapters, Guilds, Principio Rector, Assumptions & Limits
- Skill kind: model
