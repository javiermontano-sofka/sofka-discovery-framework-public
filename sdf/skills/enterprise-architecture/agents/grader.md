...
---
# Grader — enterprise-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Enterprise Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Enterprise Architecture, Strategy, Portfolio Alignment
...
- Output fabricates Strategy not supported by source data
...
- Primary concepts: Enterprise Architecture, Strategy, Portfolio Alignment

Enterprise, Principio Rector, Filosofía
- Expected sections: Enterprise Architecture: Strategy & Portfolio Alignment, Principio Rector, Filosofía de Arquitectura Enterprise
- Skill kind: generic
