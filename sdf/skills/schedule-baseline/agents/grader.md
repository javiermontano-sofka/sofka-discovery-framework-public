...
---
# Grader — schedule-baseline

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Schedule Baseline' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Schedule Baseline, Critical Path, Produces)
...
- Output fabricates Critical Path not supported by source data
...
- Primary concepts: Schedule Baseline, Critical Path, Produces, Gantt, Mermaid
- Expected sections: Schedule Baseline & Critical Path, Principio Rector, Assumptions & Limits
- Skill kind: generic
