...
- [ ] Output references the skill's primary domain (mentions 'Writing' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Writing, Information Design, Cognitive Accessibility Standards
...
- Output fabricates Information Design not supported by source data
...
- Primary concepts: Writing, Information Design, Cognitive Accessibility Standards

Ensures, Provides, Spanish-first
- Expected sections: UX Writing: Information Design & Cognitive Accessibility Standards, Principio Rector, Filosofia de UX Writing
- Skill kind: generic
