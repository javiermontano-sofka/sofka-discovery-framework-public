...
---
# Grader — product-strategy

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Product Strategy' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Product Strategy, Roadmap, Prioritization)
...
- Output fabricates Roadmap not supported by source data
...
- Primary concepts: Product Strategy, Roadmap, Prioritization, Value Stream Design

Product, Define
- Expected sections: Product Strategy: Roadmap, Prioritization & Value Stream Design, TL;DR, Inputs
- Skill kind: strategy
