...
---
# Grader — disaster-recovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Disaster Recovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Disaster Recovery, Business Continuity, Recovery Planning
...
- Output fabricates Business Continuity not supported by source data
...
- Primary concepts: Disaster Recovery, Business Continuity, Recovery Planning

Disaster, Define RPO, Recovery Point Objective
- Expected sections: Disaster Recovery: Business Continuity & Recovery Planning, TL;DR, Inputs
- Skill kind: generic
