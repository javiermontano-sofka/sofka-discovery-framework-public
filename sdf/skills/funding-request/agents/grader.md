...
---
# Grader — funding-request

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Funding Request' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Funding Request, Investment Proposal, Produces)
...
- Output fabricates Investment Proposal not supported by source data
...
- Primary concepts: Funding Request, Investment Proposal, Produces, Designed, Principio Rector
- Expected sections: Funding Request & Investment Proposal, Principio Rector, Assumptions & Limits
- Skill kind: generic
