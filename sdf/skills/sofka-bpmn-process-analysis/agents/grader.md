...
---
# Grader — sofka-bpmn-process-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'BPMN Process Analysis' or related domain terminology)
- [ ] Output contains the expected `## BPMN Process Analysis & Modeling Skill` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., BPMN Process Analysis, Modeling Skill, Purpose
...
- Output fabricates Modeling Skill not supported by source data
...
- Primary concepts: BPMN Process Analysis, Modeling Skill, Purpose

Model, BPMN, Delivers AS-IS
- Expected sections: BPMN Process Analysis & Modeling Skill, Purpose, When to Use
- Skill kind: generic
