...
---
# Grader — safe-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'SAFe Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., SAFe Maturity Assessment, Assesses, SAFe)
...
- Primary concepts: SAFe Maturity Assessment, Assesses, SAFe, Lean-Agile Leadership, Team
- Expected sections: SAFe Maturity Assessment, Principio Rector, Assumptions & Limits
