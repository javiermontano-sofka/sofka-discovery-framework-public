...
---
# Grader — governance-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Governance Framework' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Governance Framework, Escalation Paths, Designs)
...
- Output fabricates Escalation Paths not supported by source data
...
- Primary concepts: Governance Framework, Escalation Paths, Designs, Ensures, Principio Rector
- Expected sections: Governance Framework & Escalation Paths, Principio Rector, Assumptions & Limits
