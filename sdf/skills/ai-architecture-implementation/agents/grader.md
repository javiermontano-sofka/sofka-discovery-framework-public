...
---
# Grader — ai-architecture-implementation
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture Implementation, From Design, Production
...
- Output fabricates From Design not supported by source data
...
- Primary concepts: Architecture Implementation, From Design, Production

Guiar, CI/CD, Produce
- Expected sections: AI Architecture Implementation: From Design to Production, Principio Rector, Inputs
- Skill kind: generic
