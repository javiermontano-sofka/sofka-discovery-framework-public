...
---
# Grader — portfolio-risk

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Portfolio Risk Aggregation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Portfolio Risk Aggregation, Aggregates, Produces)
...
- Output fabricates Aggregates not supported by source data
...
- Primary concepts: Portfolio Risk Aggregation, Aggregates, Produces, Principio Rector, Assumptions
- Expected sections: Portfolio Risk Aggregation, Principio Rector, Assumptions & Limits
- Skill kind: generic
