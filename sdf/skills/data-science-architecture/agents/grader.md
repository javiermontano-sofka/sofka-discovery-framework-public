...
---
# Grader — data-science-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Data Science Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Science Architecture, ML/AI System Design, Model Lifecycle
...
- Output fabricates ML/AI System Design not supported by source data
...
- Primary concepts: Data Science Architecture, ML/AI System Design, Model Lifecycle

Data, Principio Rector, MLOps
- Expected sections: Data Science Architecture: ML/AI System Design & Model Lifecycle, Principio Rector, Filosofía de ML Architecture
- Skill kind: generic
