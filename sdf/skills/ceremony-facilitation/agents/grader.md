...
---
# Grader — ceremony-facilitation

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Ceremony Facilitation Guides' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Ceremony Facilitation Guides, Provides, Each)
...
- Primary concepts: Ceremony Facilitation Guides, Provides, Each, Scrum Master, Principio Rector
- Expected sections: Ceremony Facilitation Guides, Principio Rector, Assumptions & Limits
- Skill kind: generic
