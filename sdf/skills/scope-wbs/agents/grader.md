...
- [ ] Output references the skill's primary domain (mentions 'Decomposition' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Decomposition, Scope Management, Produces)
...
- Output fabricates Scope Management not supported by source data
...
- Primary concepts: Decomposition, Scope Management, Produces, Work Breakdown Structure, Decomposes
- Expected sections: WBS Decomposition & Scope Management, Principio Rector, Assumptions & Limits
- Skill kind: generic
