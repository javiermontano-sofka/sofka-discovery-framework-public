...
---
# Grader — devops-pm-alignment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'DevOps-PM Alignment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., DevOps-PM Alignment, Bridges DevOps, CI/CD)
...
- Output fabricates Bridges DevOps not supported by source data
...
- Primary concepts: DevOps-PM Alignment, Bridges DevOps, CI/CD, KPIs, Produces
- Expected sections: DevOps-PM Alignment, Principio Rector, Assumptions & Limits
- Skill kind: generic
