...
---
# Grader — closure-report

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Project Closure Report' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Project Closure Report, Produces, Ensures)
...
- Primary concepts: Project Closure Report, Produces, Ensures, Principio Rector, Assumptions
- Expected sections: Project Closure Report, Principio Rector, Assumptions & Limits
- Skill kind: generic
