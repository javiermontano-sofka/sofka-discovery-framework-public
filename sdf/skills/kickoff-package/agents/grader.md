...
---
# Grader — kickoff-package

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Kickoff Package' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Kickoff Package, Team Alignment, Produces)
...
- Output fabricates Team Alignment not supported by source data
...
- Primary concepts: Kickoff Package, Team Alignment, Produces, Principio Rector, Assumptions
- Expected sections: Kickoff Package & Team Alignment, Principio Rector, Assumptions & Limits
- Skill kind: generic
