...
---
# Grader — client-browser-audit

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Client Browser Audit' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Client Browser Audit, Playwright, Uses MCP Playwright)
...
- Primary concepts: Client Browser Audit, Playwright, Uses MCP Playwright, Jira, Azure DevOps
- Expected sections: Client Browser Audit (MCP Playwright), Principio Rector, Assumptions & Limits
- Skill kind: audit
