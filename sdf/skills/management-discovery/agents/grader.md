...
---
# Grader — management-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Management Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Management Discovery, Maturity Assessment, Transformation Roadmap
...
- Primary concepts: Management Discovery, Maturity Assessment, Transformation Roadmap

Genera, Factor WOW, Diseñado
- Expected sections: Management Discovery — PMO Maturity Assessment & Transformation Roadmap, Principio Rector, Inputs
