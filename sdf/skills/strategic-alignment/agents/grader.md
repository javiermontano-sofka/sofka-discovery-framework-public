...
---
# Grader — strategic-alignment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Strategy-to-Project Traceability' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Strategy-to-Project Traceability, Alignment, Maps)
...
- Output fabricates Alignment not supported by source data
...
- Primary concepts: Strategy-to-Project Traceability, Alignment, Maps, Uses OKR, Objectives
- Expected sections: Strategy-to-Project Traceability & OKR Alignment, Principio Rector, Assumptions & Limits
- Skill kind: generic
