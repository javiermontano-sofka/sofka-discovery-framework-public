...
---
# Grader — project-program-management

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Project' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Project, Program Management, Governance Backbone
...
- Output fabricates Program Management not supported by source data
...
- Primary concepts: Project, Program Management, Governance Backbone

Structural, Operates, Principio Rector
- Expected sections: Project & Program Management: PMO Governance Backbone, Principio Rector, Filosofía de Gobierno
- Skill kind: generic
