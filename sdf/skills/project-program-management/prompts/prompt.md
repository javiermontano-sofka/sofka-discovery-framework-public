...
description: "PMO governance, gate management, and proposal QA"
nlhp-version: "3.0"
---

# Project & Program Management

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-project-program-management`

## Invocación

```
Analiza {} usando el skill project-program-management.
...
PMO governance, gate management, and proposal QA. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
