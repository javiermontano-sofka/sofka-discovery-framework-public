...
---
# Grader — hybrid-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Hybrid Methodology Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Hybrid Methodology Maturity Assessment, Evaluates, Agile/Kanban)
...
- Output fabricates Evaluates not supported by source data
...
- Primary concepts: Hybrid Methodology Maturity Assessment, Evaluates, Agile/Kanban, Waterfall/phase-gate, Assesses
- Expected sections: Hybrid Methodology Maturity Assessment, Principio Rector, Assumptions & Limits
