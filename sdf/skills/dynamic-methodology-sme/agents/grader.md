...
---
# Grader — dynamic-methodology-sme

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Dynamic Methodology SME' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Dynamic Methodology SME, TIPO_PROYECTO, Agile)
...
- Output fabricates TIPO_PROYECTO not supported by source data
...
- Primary concepts: Dynamic Methodology SME, TIPO_PROYECTO, Agile, Waterfall, SAFe
- Expected sections: Dynamic Methodology SME, Principio Rector, Assumptions & Limits
- Skill kind: generic
