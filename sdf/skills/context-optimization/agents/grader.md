...
---
# Grader — context-optimization

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Context Window Optimization' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Context Window Optimization, Optimizes, MOAT)
...
- Output fabricates Optimizes not supported by source data
...
- Primary concepts: Context Window Optimization, Optimizes, MOAT, L1/L2/L3, Ensures
- Expected sections: Context Window Optimization, Principio Rector, Assumptions & Limits
- Skill kind: generic
