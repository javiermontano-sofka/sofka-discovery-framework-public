...
---
# prompts — aws-architecture-implementation

> Generated placeholder. Replace with skill-specific prompts.

## Purpose

This directory holds prompt assets for the `aws-architecture-implementation` skill.
