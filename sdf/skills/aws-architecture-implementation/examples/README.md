...
---
# examples — aws-architecture-implementation

> Generated placeholder. Replace with skill-specific examples.

## Purpose

This directory holds concrete worked examples for the `aws-architecture-implementation` skill.
