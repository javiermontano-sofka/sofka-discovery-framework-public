...
---
# Grader — aws-architecture-implementation

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Architecture Implementation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture Implementation, AI/GenAI Workloads
...
- Output fabricates AI/GenAI Workloads

Guiar not supported by source data
...
- Primary concepts: Architecture Implementation, AI/GenAI Workloads

Guiar, AI/GenAI, Bedrock, SageMaker
- Expected sections: AWS Architecture Implementation for AI/GenAI Workloads, Principio Rector, Inputs
- Skill kind: generic
