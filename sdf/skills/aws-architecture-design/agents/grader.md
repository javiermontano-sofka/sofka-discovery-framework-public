...
---
# Grader — aws-architecture-design

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Architecture Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture Design, AI/GenAI Workloads

Diseñar, Well-Architected Framework)
...
- Output proposes architecture without listing alternatives considered
...
- Primary concepts: Architecture Design, AI/GenAI Workloads

Diseñar, Well-Architected Framework, GenAI Lens, Principio Rector
- Expected sections: AWS Architecture Design for AI/GenAI Workloads, Principio Rector, Inputs
- Skill kind: design
