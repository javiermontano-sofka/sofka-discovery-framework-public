...
---
# Grader — cost-of-delay

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cost' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cost, Delay, WSJF Prioritization)
...
- Output fabricates Delay not supported by source data
...
- Primary concepts: Cost, Delay, WSJF Prioritization, Quantifies, Applies Weighted Shortest Job First
- Expected sections: Cost of Delay & WSJF Prioritization, Principio Rector, Assumptions & Limits
- Skill kind: generic
