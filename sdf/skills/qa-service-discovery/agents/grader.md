...
---
# Grader — qa-service-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Service Discovery' or related domain terminology)
- [ ] Output contains the expected `## QA Service Discovery — Quality Maturity Assessment & Transformation Roadmap` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Service Discovery, Quality Maturity Assessment, Transformation Roadmap
...
- Primary concepts: Service Discovery, Quality Maturity Assessment, Transformation Roadmap

Genera, TMMi, PITT
- Expected sections: QA Service Discovery — Quality Maturity Assessment & Transformation Roadmap, Principio Rector, Inputs
