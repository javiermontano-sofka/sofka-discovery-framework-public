...
---
# Grader — sofka-regional-finance

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Regional Finance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Regional Finance, Accounting Standards Skill, Purpose
...
- Output fabricates Accounting Standards Skill not supported by source data
...
- Primary concepts: Regional Finance, Accounting Standards Skill, Purpose

Provide, Colombia, Ecuador
- Expected sections: Regional Finance & Accounting Standards Skill, Purpose, When to Use
- Skill kind: generic
