...
---
# Grader — release-strategy

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Estrategia' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Estrategia, Release
...
- Primary concepts: Estrategia, Release

Diseno, Evalua, CI/CD, Selecciona
- Expected sections: Estrategia de Release, TL;DR, Inputs
- Skill kind: strategy
