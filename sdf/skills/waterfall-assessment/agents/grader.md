...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Waterfall, Traditional, Maturity Assessment)
...
- Output fabricates Traditional not supported by source data
...
- Primary concepts: Waterfall, Traditional, Maturity Assessment, Assesses, PMBOK
- Expected sections: Waterfall / Traditional PM Maturity Assessment, Principio Rector, Assumptions & Limits
