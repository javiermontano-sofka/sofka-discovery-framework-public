...
- [ ] Output references the skill's primary domain (mentions 'Copywriting' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Copywriting, Persuasive Executive Communication
...
- Output fabricates Persuasive Executive Communication

Transforms not supported by source data
...
- Primary concepts: Copywriting, Persuasive Executive Communication

Transforms, Owns, Guiding Principle, C-level
- Expected sections: Copywriting — Persuasive Executive Communication, Guiding Principle, Persuasion Philosophy
- Skill kind: generic
