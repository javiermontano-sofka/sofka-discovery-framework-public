...
---
# Grader — monte-carlo-simulation

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Monte Carlo Simulation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Monte Carlo Simulation, Schedule, Cost)
...
- Output fabricates Schedule not supported by source data
...
- Primary concepts: Monte Carlo Simulation, Schedule, Cost, Executes Monte Carlo, Provides
- Expected sections: Monte Carlo Simulation (Schedule & Cost), Principio Rector, Assumptions & Limits
- Skill kind: generic
