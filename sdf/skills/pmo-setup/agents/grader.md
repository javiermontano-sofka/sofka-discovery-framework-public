...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Design, Setup, Designs)
...
- Output fabricates Setup not supported by source data
...
- Primary concepts: Design, Setup, Designs, Project Management Office, Principio Rector
- Expected sections: PMO Design & Setup, Principio Rector, Assumptions & Limits
- Skill kind: generic
