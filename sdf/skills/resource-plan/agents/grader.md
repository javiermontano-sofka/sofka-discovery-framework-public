...
---
# Grader — resource-plan

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Resource Allocation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Resource Allocation, Capacity Planning, Produces)
...
- Output fabricates Capacity Planning not supported by source data
...
- Primary concepts: Resource Allocation, Capacity Planning, Produces, RACI, Identifies
- Expected sections: Resource Allocation & Capacity Planning, Principio Rector, Assumptions & Limits
- Skill kind: plan
