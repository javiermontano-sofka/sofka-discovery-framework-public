...
---
# Grader — data-governance

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Data Governance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Governance, Catalog, Ownership)
...
- Output fabricates Catalog not supported by source data
...
- Primary concepts: Data Governance, Catalog, Ownership, Classification, Compliance

Data
- Expected sections: Data Governance: Catalog, Ownership, Classification & Compliance, Principio Rector, Inputs
- Skill kind: generic
