...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture Audit, Systematic Assessment, AI-Enabled Systems
...
- Primary concepts: Architecture Audit, Systematic Assessment, AI-Enabled Systems

Auditar, Produce, Principio Rector
- Expected sections: AI Architecture Audit: Systematic Assessment of AI-Enabled Systems, Principio Rector, Inputs
- Skill kind: audit
