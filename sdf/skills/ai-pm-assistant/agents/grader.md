...
---
# Grader — ai-pm-assistant

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'AI-Augmented' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., AI-Augmented, Assistant, Identifies)
...
- Output fabricates Assistant not supported by source data
...
- Primary concepts: AI-Augmented, Assistant, Identifies, NLP-based, Produces
- Expected sections: AI-Augmented PM Assistant, Principio Rector, Assumptions & Limits
- Skill kind: generic
