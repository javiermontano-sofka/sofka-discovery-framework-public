...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Testing Strategy, Comprehensive Verification, AI-Enabled Systems)
...
- Output fabricates Comprehensive Verification not supported by source data
...
- Primary concepts: Testing Strategy, Comprehensive Verification, AI-Enabled Systems, CI/CD, Principio Rector
- Expected sections: AI Testing Strategy: Comprehensive Verification for AI-Enabled Systems, Principio Rector, Filosofia de Testing para IA
- Skill kind: strategy
