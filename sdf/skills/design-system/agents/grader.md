...
---
# Grader — design-system

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Design System' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Design System, Brand-Configurable, Foundation)
...
- Primary concepts: Design System, Brand-Configurable, Foundation, HTML, CRITICAL
- Expected sections: Design System v4 (Brand-Configurable), Principio Rector, Filosofía de Design System
- Skill kind: design
