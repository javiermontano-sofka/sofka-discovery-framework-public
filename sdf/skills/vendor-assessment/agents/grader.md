...
---
# Grader — vendor-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Vendor Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Vendor Assessment, Evaluation, Selection)
...
- Output fabricates Evaluation not supported by source data
...
- Primary concepts: Vendor Assessment, Evaluation, Selection, Risk Analysis

Vendor, Disena
- Expected sections: Vendor Assessment: Evaluation, Selection & Risk Analysis, TL;DR, Inputs
