...
---
# Grader — infrastructure-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Infrastructure Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Infrastructure Architecture, Platform, Runtime Design
...
- Output fabricates Platform not supported by source data
...
- Primary concepts: Infrastructure Architecture, Platform, Runtime Design

Infrastructure, Principio Rector, Filosofía
- Expected sections: Infrastructure Architecture: Platform & Runtime Design, Principio Rector, Filosofía de Infraestructura
- Skill kind: generic
