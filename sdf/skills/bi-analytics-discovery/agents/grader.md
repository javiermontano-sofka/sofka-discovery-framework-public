...
---
# Grader — bi-analytics-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Analytics Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Analytics Discovery, Data Maturity Assessment, Transformation Roadmap
...
- Primary concepts: Analytics Discovery, Data Maturity Assessment, Transformation Roadmap

Genera, Analytics, DCAM/DMM
- Expected sections: BI & Analytics Discovery — Data Maturity Assessment & Transformation Roadmap, Principio Rector, Inputs
