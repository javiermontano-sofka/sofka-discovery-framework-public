...
---
# Grader — assumption-log

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Assumption Tracking' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Assumption Tracking, Constraint Documentation, Maintains)
...
- Output fabricates Constraint Documentation not supported by source data
...
- Primary concepts: Assumption Tracking, Constraint Documentation, Maintains, Each, Integrates
- Expected sections: Assumption Tracking & Constraint Documentation, Principio Rector, Assumptions & Limits
- Skill kind: generic
