...
---
# Grader — risk-monitoring

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Risk Monitoring' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Risk Monitoring, Dashboard, Implements)
...
- Output fabricates Dashboard not supported by source data
...
- Primary concepts: Risk Monitoring, Dashboard, Implements, Tracks, Principio Rector
- Expected sections: Risk Monitoring & Dashboard, Principio Rector, Assumptions & Limits
- Skill kind: generic
