...
---
# Grader — dependency-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Analisis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Analisis, Dependencias
...
- Output fabricates Dependencias

Mapeo not supported by source data
...
- Primary concepts: Analisis, Dependencias

Mapeo, Construye, Identifica, CVEs
- Expected sections: Analisis de Dependencias, TL;DR, Inputs
- Skill kind: generic
