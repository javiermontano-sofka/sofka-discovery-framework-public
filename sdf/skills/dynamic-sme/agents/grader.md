...
- [ ] Output references the skill's primary domain (mentions 'Dynamic Subject Matter Expert' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Dynamic Subject Matter Expert, Purpose
...
Dynamic not supported by source data
...
- Primary concepts: Dynamic Subject Matter Expert, Purpose

Dynamic, Provides, Principio Rector, Contexto
- Expected sections: Dynamic Subject Matter Expert, Purpose, Principio Rector
- Skill kind: generic
