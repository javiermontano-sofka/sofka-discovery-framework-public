...
---
# Grader — pipeline-governance

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Pipeline Governance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Pipeline Governance, Discovery Pipeline Governance Backbone
...
- Output fabricates Discovery Pipeline Governance Backbone

Structural not supported by source data
...
- Primary concepts: Pipeline Governance, Discovery Pipeline Governance Backbone

Structural, Operates, Guiding Principle, Discovery
- Expected sections: Pipeline Governance: Discovery Pipeline Governance Backbone, Guiding Principle, Governance Philosophy
- Skill kind: generic
