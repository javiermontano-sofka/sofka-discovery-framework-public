...
---
# Grader — team-topology-design

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Team Topology Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Team Topology Design, Designs, Team Topologies)
...
- Primary concepts: Team Topology Design, Designs, Team Topologies, Considers Conway, X-as-a-Service
- Expected sections: Team Topology Design, Principio Rector, Assumptions & Limits
- Skill kind: design
