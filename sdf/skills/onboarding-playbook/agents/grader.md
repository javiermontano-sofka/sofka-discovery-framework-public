...
---
# Grader — onboarding-playbook

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Team Onboarding' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Team Onboarding, Knowledge Transfer Playbook, Creates)
...
- Output fabricates Knowledge Transfer Playbook not supported by source data
...
- Primary concepts: Team Onboarding, Knowledge Transfer Playbook, Creates, Reduces, Principio Rector
Cada
- Expected sections: Team Onboarding & Knowledge Transfer Playbook, Principio Rector, Assumptions & Limits
- Skill kind: playbook
