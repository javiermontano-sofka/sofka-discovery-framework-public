...
---
# Grader — communication-plan

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Communication Plan' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Communication Plan, Matrix, Designs)
...
- Output fabricates Matrix not supported by source data
...
- Primary concepts: Communication Plan, Matrix, Designs, Ensures, Principio Rector
- Expected sections: Communication Plan & Matrix, Principio Rector, Assumptions & Limits
- Skill kind: plan
