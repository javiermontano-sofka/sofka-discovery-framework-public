...
- [ ] Output references the skill's primary domain (mentions 'Flow Mapping' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Flow Mapping, Domains, Business Flows
...
- Output fabricates Domains not supported by source data
...
- Primary concepts: Flow Mapping, Domains, Business Flows

Translates AS-IS, Delivers DDD, Principio Rector
- Expected sections: Flow Mapping — DDD Domains & Business Flows, Principio Rector, Filosofía de Mapeo
- Skill kind: generic
