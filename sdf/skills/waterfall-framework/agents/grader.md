...
---
# Grader — waterfall-framework

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Waterfall' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Waterfall, Traditional Framework, Designs)
...
- Output fabricates Traditional Framework not supported by source data
...
- Primary concepts: Waterfall, Traditional Framework, Designs, PMBOK, PRINCE2
- Expected sections: Waterfall / Traditional Framework, Principio Rector, Assumptions & Limits
