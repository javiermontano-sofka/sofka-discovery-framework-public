...
---
# Grader — discovery-retrospective

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Discovery Retrospective' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Discovery Retrospective, Conducts, Produces)
...
- Primary concepts: Discovery Retrospective, Conducts, Produces, APEX, Principio Rector
- Expected sections: Discovery Retrospective, Principio Rector, Assumptions & Limits
