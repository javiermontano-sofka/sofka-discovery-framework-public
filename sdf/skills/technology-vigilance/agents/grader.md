...
---
# Grader — technology-vigilance

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Technology Vigilance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Technology Vigilance, Proactive Technology Intelligence

Structured, Guiding Principle)
...
- Output fabricates Proactive Technology Intelligence

Structured not supported by source data
...
- Primary concepts: Technology Vigilance, Proactive Technology Intelligence

Structured, Guiding Principle, Technology, Vigilance Philosophy
- Expected sections: Technology Vigilance: Proactive Technology Intelligence, Guiding Principle, Vigilance Philosophy
- Skill kind: generic
