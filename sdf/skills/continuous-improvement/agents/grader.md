...
---
# Grader — continuous-improvement

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Continuous Improvement' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Continuous Improvement, Kaizen, Implements)
...
- Output fabricates Kaizen not supported by source data
...
- Primary concepts: Continuous Improvement, Kaizen, Implements, PDCA, Identifies
- Expected sections: Continuous Improvement & Kaizen, Principio Rector, Assumptions & Limits
- Skill kind: generic
