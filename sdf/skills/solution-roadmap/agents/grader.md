...
---
# Grader — solution-roadmap

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Solution Roadmap' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Solution Roadmap, Transformation Blueprint
...
- Output fabricates Transformation Blueprint

Defines not supported by source data
...
- Primary concepts: Solution Roadmap, Transformation Blueprint

Defines, AFTER, BEFORE PoC, Covers
- Expected sections: Solution Roadmap — Transformation Blueprint, Principio Rector, Filosofía de Transformación
- Skill kind: generic
