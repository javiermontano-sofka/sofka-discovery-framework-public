...
---
# Grader — pmo-health-check

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Health Check' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Health Check, Internal, Phase)
...
- Output fabricates Internal not supported by source data
...
- Primary concepts: Health Check, Internal, Phase, Designed, INTERNAL
- Expected sections: PMO Health Check (Internal), Principio Rector, Assumptions & Limits
- Skill kind: generic
