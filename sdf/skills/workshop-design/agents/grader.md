...
---
# Grader — workshop-design

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Workshop Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Workshop Design, Collaborative Discovery, Design Techniques
...
- Primary concepts: Workshop Design, Collaborative Discovery, Design Techniques

Workshop, Covers, Guiding Principle
- Expected sections: Workshop Design: Collaborative Discovery & Design Techniques, Guiding Principle, Inputs
- Skill kind: design
