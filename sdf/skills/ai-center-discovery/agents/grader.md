...
---
# Grader — ai-center-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Center Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Center Discovery, Readiness Assessment, Adoption Roadmap
...
- Primary concepts: Center Discovery, Readiness Assessment, Adoption Roadmap

Genera, Center, SCALE
- Expected sections: AI Center Discovery — AI Readiness Assessment & Adoption Roadmap, Principio Rector, Inputs
