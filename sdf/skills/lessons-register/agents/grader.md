...
---
# Grader — lessons-register

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Lessons Learned Capture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Lessons Learned Capture, Register, Systematically)
...
- Output fabricates Register not supported by source data
...
- Primary concepts: Lessons Learned Capture, Register, Systematically, Maintains, Principio Rector
Una
- Expected sections: Lessons Learned Capture & Register, Principio Rector, Assumptions & Limits
- Skill kind: register
