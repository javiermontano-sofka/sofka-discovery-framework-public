...
---
# Grader — compliance-tracking

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Regulatory Compliance Tracking' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Regulatory Compliance Tracking, Tracks, Maintains)
...
- Output fabricates Tracks not supported by source data
...
- Primary concepts: Regulatory Compliance Tracking, Tracks, Maintains, Principio Rector, Assumptions
- Expected sections: Regulatory Compliance Tracking, Principio Rector, Assumptions & Limits
- Skill kind: generic
