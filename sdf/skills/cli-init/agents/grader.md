...
- [ ] Output references the skill's primary domain (mentions 'MetodologIA' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., MetodologIA, Configura, Claude Code)
...
- Output fabricates Configura not supported by source data
...
- Primary concepts: MetodologIA, Configura, Claude Code, Wizard, SESSION-README
- Expected sections: cli-init, TL;DR, Core Responsibilities
- Skill kind: generic
