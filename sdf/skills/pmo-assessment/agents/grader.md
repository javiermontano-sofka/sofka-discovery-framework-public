...
---
# Grader — pmo-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Assessment, Evaluates PMO, Assesses)
...
- Output fabricates Evaluates PMO not supported by source data
...
- Primary concepts: Assessment, Evaluates PMO, Assesses, Produces, Principio Rector
- Expected sections: PMO Assessment, Principio Rector, Assumptions & Limits
