...
---
# Grader — integration-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Integration Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Integration Architecture, System Connectivity, Contract Design
...
- Output fabricates System Connectivity not supported by source data
...
- Primary concepts: Integration Architecture, System Connectivity, Contract Design

Integration, Mapea, Selecciona
- Expected sections: Integration Architecture: System Connectivity & API Contract Design, TL;DR, Inputs
- Skill kind: generic
