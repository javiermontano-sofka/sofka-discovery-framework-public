...
---
# Grader — scenario-analysis

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Strategic Scenario Analysis' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Strategic Scenario Analysis, Tree, Thought
...
- Output fabricates Tree not supported by source data
...
- Primary concepts: Strategic Scenario Analysis, Tree, Thought

Develops, SWOT, Inputs
- Expected sections: Strategic Scenario Analysis — Tree of Thought, Inputs, Principio Rector
- Skill kind: generic
