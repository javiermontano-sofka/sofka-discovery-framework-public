...
---
# Grader — solutions-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Solutions Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Solutions Architecture, End-to-End Capability Delivery

Solutions, Principio Rector)
...
- Output fabricates End-to-End Capability Delivery

Solutions not supported by source data
...
- Primary concepts: Solutions Architecture, End-to-End Capability Delivery

Solutions, Principio Rector, APIs, Cada
- Expected sections: Solutions Architecture: End-to-End Capability Delivery, Principio Rector, Filosofía de Solución End-to-End
- Skill kind: generic
