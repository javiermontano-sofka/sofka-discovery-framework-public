...
---
# Grader — portfolio-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Portfolio Management Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Portfolio Management Maturity Assessment, Assesses, Evaluates)
...
- Output fabricates Assesses not supported by source data
...
- Primary concepts: Portfolio Management Maturity Assessment, Assesses, Evaluates, Produces, Principio Rector
- Expected sections: Portfolio Management Maturity Assessment, Principio Rector, Assumptions & Limits
