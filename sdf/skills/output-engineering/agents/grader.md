...
---
# Grader — output-engineering

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Multi-Format Deliverable Production' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Multi-Format Deliverable Production, Produces, Markdown)
...
- Primary concepts: Multi-Format Deliverable Production, Produces, Markdown, HTML, Mermaid
- Expected sections: Multi-Format Deliverable Production, Principio Rector, Assumptions & Limits
- Skill kind: engine
