...
- [ ] Output references the skill's primary domain (mentions 'Data Quality' or related domain terminology)
- [ ] Output contains the expected `## Data Quality: Framework Design for Validation, Contracts & Monitoring` section as defined in SKILL.md
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Quality, Framework Design, Validation)
...
- Output fabricates Framework Design not supported by source data
...
- Primary concepts: Data Quality, Framework Design, Validation, Contracts, Monitoring

Data
- Expected sections: Data Quality: Framework Design for Validation, Contracts & Monitoring, Principio Rector, Inputs
- Skill kind: generic
