...
---
# Grader — stakeholder-register

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Stakeholder Register' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Stakeholder Register, Analysis, Identifies)
...
- Primary concepts: Stakeholder Register, Analysis, Identifies, Produces, Principio Rector
Los
- Expected sections: Stakeholder Register & Analysis, Principio Rector, Assumptions & Limits
- Skill kind: register
