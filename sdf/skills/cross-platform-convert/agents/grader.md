...
---
# Grader — cross-platform-convert

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cross-Platform Skill Conversion' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cross-Platform Skill Conversion, Converts PMO-APEX, Claude Code)
...
- Output fabricates Converts PMO-APEX not supported by source data
...
- Primary concepts: Cross-Platform Skill Conversion, Converts PMO-APEX, Claude Code, Cursor, GitHub Codex
- Expected sections: Cross-Platform Skill Conversion, Principio Rector, Assumptions & Limits
- Skill kind: generic
