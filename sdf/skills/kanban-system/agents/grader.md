...
---
# Grader — kanban-system

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Kanban System Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Kanban System Design, Designs, Kanban)
...
- Primary concepts: Kanban System Design, Designs, Kanban, Optimizes, Principio Rector
Kanban
- Expected sections: Kanban System Design, Principio Rector, Assumptions & Limits
- Skill kind: generic
