...
---
# Grader — project-charter

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Project Charter Generation' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Project Charter Generation, Produces, Principio Rector)
...
- Primary concepts: Project Charter Generation, Produces, Principio Rector, Cada, Assumptions
- Expected sections: Project Charter Generation, Principio Rector, Assumptions & Limits
- Skill kind: generic
