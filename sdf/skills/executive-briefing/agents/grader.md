...
---
# Grader — executive-briefing

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Executive Briefing' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Executive Briefing, Sponsor Updates, Produces)
...
- Output fabricates Sponsor Updates not supported by source data
...
- Primary concepts: Executive Briefing, Sponsor Updates, Produces, Distills, Designed
- Expected sections: Executive Briefing & Sponsor Updates, Principio Rector, Assumptions & Limits
- Skill kind: generic
