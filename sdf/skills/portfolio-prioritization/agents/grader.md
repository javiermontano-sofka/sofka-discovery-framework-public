...
---
# Grader — portfolio-prioritization

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Portfolio Prioritization' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Portfolio Prioritization, Scoring Models, Applies)
...
- Output fabricates Scoring Models not supported by source data
...
- Primary concepts: Portfolio Prioritization, Scoring Models, Applies, Produces, Principio Rector
Sin
- Expected sections: Portfolio Prioritization & Scoring Models, Principio Rector, Assumptions & Limits
- Skill kind: generic
