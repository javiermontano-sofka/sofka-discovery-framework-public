...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Alcance, TIPO_SERVICIO, Cloud)
...
- Primary concepts: Alcance, TIPO_SERVICIO, Cloud, CI/CD, DevSecOps Architecture
- Expected sections: DevSecOps Architecture: Delivery & Security Pipeline, Principio Rector, Filosofía DevSecOps
- Skill kind: generic
