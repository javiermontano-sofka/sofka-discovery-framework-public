...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture, Design, Governance)
...
- Output fabricates Design not supported by source data
...
- Primary concepts: Architecture, Design, Governance, Developer Experience

API, APIs
- Expected sections: API Architecture: Design, Governance & Developer Experience, Principio Rector, Filosofía de API Architecture
- Skill kind: generic
