...
- [ ] Output references the skill's primary domain (mentions 'FinOps' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., FinOps, Cloud Financial Operations

Generates, Crawl/Walk/Run)
...
- Output fabricates Cloud Financial Operations
...
- Primary concepts: FinOps, Cloud Financial Operations

Generates, Crawl/Walk/Run, Guiding Principle, Cloud
- Expected sections: FinOps — Cloud Financial Operations, Guiding Principle, Inputs
- Skill kind: generic
