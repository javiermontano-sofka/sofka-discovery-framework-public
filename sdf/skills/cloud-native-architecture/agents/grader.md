...
---
# Grader — cloud-native-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cloud-Native Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cloud-Native Architecture, Containers, Mesh)
...
- Output fabricates Containers not supported by source data
...
- Primary concepts: Cloud-Native Architecture, Containers, Mesh, Serverless, Cost Optimization

Cloud-native
- Expected sections: Cloud-Native Architecture: Containers, Mesh, Serverless & Cost Optimization, Principio Rector, Filosofía de Cloud-Native
- Skill kind: generic
