...
---
# Grader — ux-design-discovery

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Design Discovery' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Design Discovery, Design Maturity, Transformation Assessment
...
- Primary concepts: Design Discovery, Design Maturity, Transformation Assessment

Generates, UX/UI, Produces
- Expected sections: UX Design Discovery — Design Maturity & Transformation Assessment, Principio Rector, Inputs
