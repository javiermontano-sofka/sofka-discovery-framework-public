...
- [ ] Output references the skill's primary domain (mentions 'Tool' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Tool, Methodology Evaluation, Designs)
...
- Output fabricates Methodology Evaluation not supported by source data
...
- Primary concepts: Tool, Methodology Evaluation, Designs, Proofs, Concept
- Expected sections: PoC Lab for PM Tool & Methodology Evaluation, Principio Rector, Assumptions & Limits
- Skill kind: generic
