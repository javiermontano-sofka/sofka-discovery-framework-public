...
---
# Grader — discovery-handover

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Discovery Handover' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Discovery Handover, Phase, Transición)
...
- Primary concepts: Discovery Handover, Phase, Transición, Ejecución

Genera, Fases
- Expected sections: Discovery Handover — Phase 6: Transición a Ejecución, Principio Rector, Filosofía de Transición
