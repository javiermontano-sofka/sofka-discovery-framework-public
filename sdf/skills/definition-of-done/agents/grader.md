...
---
# Grader — definition-of-done

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Definition' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Definition, Done, Ready Standards)
...
- Output fabricates Done not supported by source data
...
- Primary concepts: Definition, Done, Ready Standards, Establishes, Ready
- Expected sections: Definition of Done / Definition of Ready Standards, Principio Rector, Assumptions & Limits
- Skill kind: generic
