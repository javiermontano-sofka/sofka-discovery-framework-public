...
---
# Grader — sector-intelligence

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Sector Intelligence' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Sector Intelligence, Purpose

Industry/sector, Provides)
...
- Output fabricates Purpose

Industry/sector not supported by source data
...
- Primary concepts: Sector Intelligence, Purpose

Industry/sector, Provides, Guiding Principle, Technology
- Expected sections: Sector Intelligence, Purpose, Guiding Principle
- Skill kind: generic
