...
---
# Grader — team-topology

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Team Topology' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Team Topology, Organizational Design, Fast Flow
...
- Output fabricates Organizational Design not supported by source data
...
- Primary concepts: Team Topology, Organizational Design, Fast Flow

Team, Team Topologies, Skelton
- Expected sections: Team Topology: Organizational Design for Fast Flow, TL;DR, Inputs
- Skill kind: generic
