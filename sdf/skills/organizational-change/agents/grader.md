...
---
# Grader — organizational-change

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Organizational Change Management' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Organizational Change Management, Designs, ADKAR)
...
- Primary concepts: Organizational Change Management, Designs, ADKAR, Awareness, Desire
- Expected sections: Organizational Change Management (OCM), Principio Rector, Assumptions & Limits
- Skill kind: generic
