...
- [ ] Output references the skill's primary domain (mentions 'Design' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Design, Service Level Objectives, Indicators)
...
- Primary concepts: Design, Service Level Objectives, Indicators, Agreements

SLA, Google SRE
- Expected sections: SLA Design: Service Level Objectives, Indicators & Agreements, TL;DR, Inputs
- Skill kind: design
