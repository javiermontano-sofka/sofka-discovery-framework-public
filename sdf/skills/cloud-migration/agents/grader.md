...
---
# Grader — cloud-migration

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Cloud Migration' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Cloud Migration, Assessment, Planning)
...
- Primary concepts: Cloud Migration, Assessment, Planning, Execution

Cloud, Principio Rector
- Expected sections: Cloud Migration: Assessment, Planning & Execution, Principio Rector, Filosofía de Migración Cloud
- Skill kind: generic
