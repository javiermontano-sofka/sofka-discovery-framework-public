...
---
# Grader — vendor-management

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Vendor Performance' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Vendor Performance, Monitoring, Manages)
...
- Output fabricates Monitoring not supported by source data
...
- Primary concepts: Vendor Performance, Monitoring, Manages, Produces, Principio Rector
- Expected sections: Vendor Performance & SLA Monitoring, Principio Rector, Assumptions & Limits
- Skill kind: generic
