...
---
# Grader — event-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Event Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Event Architecture, Catalog, Consistency Patterns)
...
- Primary concepts: Event Architecture, Catalog, Consistency Patterns, Operational Excellence

Event-driven, CQRS
- Expected sections: Event Architecture: Catalog, Consistency Patterns & Operational Excellence, Principio Rector, Filosofía de Event Architecture
- Skill kind: generic
