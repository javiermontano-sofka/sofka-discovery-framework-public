...
- [ ] Output references the skill's primary domain (mentions 'Integration Plan' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Integration Plan, Cross-Project Dependencies, Produces)
...
- Output fabricates Cross-Project Dependencies not supported by source data
...
- Primary concepts: Integration Plan, Cross-Project Dependencies, Produces, Ensures, Principio Rector
- Expected sections: Integration Plan & Cross-Project Dependencies, Principio Rector, Assumptions & Limits
- Skill kind: plan
