...
---
# Grader — ai-design-patterns

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Design Patterns' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Design Patterns, Patterns, Tactics)
...
- Primary concepts: Design Patterns, Patterns, Tactics, AI-Enabled Systems, AI-specific
- Expected sections: AI Design Patterns: Patterns & Tactics for AI-Enabled Systems, Principio Rector, Filosofia de Design Patterns para IA
- Skill kind: design
