...
---
# Grader — rendering-engine

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Rendering Engine' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Rendering Engine, Mermaid-to-PNG, Markdown-to-PDF)
...
- Output fabricates Mermaid-to-PNG not supported by source data
...
- Primary concepts: Rendering Engine, Mermaid-to-PNG, Markdown-to-PDF, Converts, Mermaid
- Expected sections: Rendering Engine (Mermaid-to-PNG, Markdown-to-PDF), Principio Rector, Assumptions & Limits
- Skill kind: engine
