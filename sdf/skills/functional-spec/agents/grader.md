...
---
# Grader — functional-spec

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Functional Specification' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Functional Specification, Universal Deliverable Specification
...
- Output fabricates Universal Deliverable Specification
...
- Primary concepts: Functional Specification, Universal Deliverable Specification

Generates, Nota, CUALQUIER, MetodologIA
- Expected sections: Functional Specification — Universal Deliverable Specification, Principio Rector, Filosofía de Especificación
- Skill kind: generic
