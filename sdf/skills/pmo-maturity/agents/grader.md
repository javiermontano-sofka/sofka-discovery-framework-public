...
- [ ] Output references the skill's primary domain (mentions 'Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Maturity Assessment, OPM3, P3M3)
...
- Output fabricates OPM3 not supported by source data
...
- Primary concepts: Maturity Assessment, OPM3, P3M3, Assesses, Organizational Project Management Maturity Model
- Expected sections: PMO Maturity Assessment (OPM3 / P3M3), Principio Rector, Assumptions & Limits
- Skill kind: generic
