...
---
# Grader — kanban-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Kanban Maturity Assessment' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Kanban Maturity Assessment, Assesses, Kanban)
...
- Primary concepts: Kanban Maturity Assessment, Assesses, Kanban, Kanban Maturity Model, Produces
- Expected sections: Kanban Maturity Assessment, Principio Rector, Assumptions & Limits
