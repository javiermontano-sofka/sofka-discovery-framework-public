...
---
# Grader — security-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Security Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Security Architecture, Threat Modeling, Identity)
...
- Output fabricates Threat Modeling not supported by source data
...
- Primary concepts: Security Architecture, Threat Modeling, Identity, Compliance Design

Security, Principio Rector
- Expected sections: Security Architecture: Threat Modeling, Identity & Compliance Design, Principio Rector, Filosofía de Security Architecture
- Skill kind: generic
