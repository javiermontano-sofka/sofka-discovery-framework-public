...
description: "Mermaid diagram generation for architecture visualization"
nlhp-version: "3.0"
---

# Mermaid Diagramming

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-mermaid-diagramming`

## Invocación

```
Analiza {} usando el skill mermaid-diagramming.
...
Mermaid diagram generation for architecture visualization. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
