...
---
# Grader — mermaid-diagramming

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Mermaid Diagramming Engine
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Mermaid Diagramming Engine

Generates, Mermaid, Every)
...
- Output fabricates Mermaid not supported by source data
...
- Primary concepts: Mermaid Diagramming Engine

Generates, Mermaid, Every, Each, Principio Rector
- Expected sections: Mermaid Diagramming Engine, Principio Rector, Filosofía de Diagramación
- Skill kind: generic
