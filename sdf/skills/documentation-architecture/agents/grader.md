...
---
# Grader — documentation-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Arquitectura' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Arquitectura, Documentacion
...
- Output fabricates Documentacion

Diseno not supported by source data
...
- Primary concepts: Arquitectura, Documentacion

Diseno, Evalua, Disena, Diataxis
- Expected sections: Arquitectura de Documentacion, TL;DR, Inputs
- Skill kind: generic
