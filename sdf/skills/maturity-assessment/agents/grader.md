...
---
# Grader — maturity-assessment

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Overall' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Overall, Maturity Assessment, Assesses)
...
- Output fabricates Maturity Assessment not supported by source data
...
- Primary concepts: Overall, Maturity Assessment, Assesses, OPM3, P3M3
- Expected sections: Overall PM Maturity Assessment, Principio Rector, Assumptions & Limits
