...
---
# Grader — performance-engineering

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Performance Engineering' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Performance Engineering, Assessment, Optimization)
...
- Output fabricates Assessment not supported by source data
...
- Primary concepts: Performance Engineering, Assessment, Optimization, Capacity Strategy

Performance, SLA/SLO
- Expected sections: Performance Engineering: Assessment, Optimization & Capacity Strategy, Principio Rector, Filosofía de Performance Engineering
- Skill kind: engine
