...
---
# Grader — data-storytelling

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Data Storytelling' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Data Storytelling, Metrics, Meaning
...
- Output fabricates Metrics not supported by source data
...
- Primary concepts: Data Storytelling, Metrics, Meaning

Transforms, Owns, Guiding Principle
- Expected sections: Data Storytelling — Metrics to Meaning, Guiding Principle, Narrative Data Philosophy
- Skill kind: generic
