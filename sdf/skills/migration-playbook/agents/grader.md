...
---
# Grader — migration-playbook

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Migration Playbook' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Migration Playbook, Execution Strategy, Cutover Planning
...
- Output fabricates Execution Strategy not supported by source data
...
- Primary concepts: Migration Playbook, Execution Strategy, Cutover Planning

Migration, Selecciona, Disena
- Expected sections: Migration Playbook: Execution Strategy & Cutover Planning, TL;DR, Inputs
- Skill kind: playbook
