...
---
# Grader — bi-architecture

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Architecture' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Architecture, Business Intelligence Solution Design, Analytics Strategy)
...
- Output fabricates Business Intelligence Solution Design not supported by source data
...
- Primary concepts: Architecture, Business Intelligence Solution Design, Analytics Strategy, Principio Rector, Filosofía
- Expected sections: BI Architecture: Business Intelligence Solution Design & Analytics Strategy, Principio Rector, Filosofía BI
- Skill kind: generic
