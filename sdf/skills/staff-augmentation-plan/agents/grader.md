...
---
# Grader — staff-augmentation-plan

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Staff Augmentation Planning' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Staff Augmentation Planning, Plans, Ensures)
...
- Output fabricates Plans not supported by source data
...
- Primary concepts: Staff Augmentation Planning, Plans, Ensures, Principio Rector, Assumptions
- Expected sections: Staff Augmentation Planning, Principio Rector, Assumptions & Limits
- Skill kind: plan
