...
---
# Grader — dashboard-tooling

> Domain-specific QA grader. Generated from SKILL.md analysis.

## Critical assertions

- [ ] Output references the skill's primary domain (mentions 'Dashboard Tooling' or related domain terminology)
...
- [ ] Output mentions at least 3 distinct domain concepts from this skill (e.g., Dashboard Tooling, Data Feeds, Configures)
...
- Output fabricates Data Feeds not supported by source data
...
- Primary concepts: Dashboard Tooling, Data Feeds, Configures, Ensures, Principio Rector
- Expected sections: Dashboard Tooling & Data Feeds, Principio Rector, Assumptions & Limits
- Skill kind: generic
