#!/usr/bin/env bash
# convert-skills.sh — Cross-platform skill converter for MAO MOAT skills
...
#   codex     → AGENTS.md sections (OpenAI Codex CLI)
#   gemini    → .gemini/style.md (Gemini CLI)
#   aider     → .aider.conf.yml + conventions (Aider)
...
# AGENTS.md — Converted from MAO MOAT Skills
# Generated: $TIMESTAMP
# Source: MAO Framework — MetodologIA Discovery Framework
...
# Gemini Style Guide — Converted from MAO MOAT Skills
# Generated: $TIMESTAMP
...
convert_aider() {
  ...
  # Aider uses convention files per directory
  local conventions_file="$out/CONVENTIONS.md"

  cat > "$conventions_file" <<HEADER
# CONVENTIONS.md — Converted from MAO MOAT Skills
# Generated: $TIMESTAMP
...
# .windsurfrules — Converted from MAO MOAT Skills
# Generated: $TIMESTAMP
...
# ─── Execute Conversion ───
echo "MAO Cross-Platform Skill Converter"
echo "===================================="
