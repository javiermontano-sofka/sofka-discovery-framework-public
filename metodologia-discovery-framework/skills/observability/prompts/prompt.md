...
> Ejecuta el skill **observability** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **observability** dentro del pipeline de discovery de MetodologIA.
