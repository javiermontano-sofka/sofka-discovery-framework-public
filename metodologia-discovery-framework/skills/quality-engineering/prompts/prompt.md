...
> Ejecuta el skill **quality-engineering** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **quality-engineering** dentro del pipeline de discovery de MetodologIA.
...
Skill: `quality-engineering/SKILL.md`
