...
> Ejecuta el skill **user-representative** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **user-representative** dentro del pipeline de discovery de MetodologIA.
...
Skill: `user-representative/SKILL.md`
