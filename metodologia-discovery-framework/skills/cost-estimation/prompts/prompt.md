...
> Ejecuta el skill **cost-estimation** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **cost-estimation** dentro del pipeline de discovery de MetodologIA.
...
Skill: `cost-estimation/SKILL.md`
