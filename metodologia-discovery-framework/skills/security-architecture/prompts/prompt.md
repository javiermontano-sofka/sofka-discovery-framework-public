...
> Ejecuta el skill **security-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **security-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `security-architecture/SKILL.md`
