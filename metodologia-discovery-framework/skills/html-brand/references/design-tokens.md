...
:root {
  /* BRAND CORE */
  --metodologia-orange: #FF7E08;
  --metodologia-orange-light: #FF9E42;
  --metodologia-orange-dark: #CC6506;
  --metodologia-orange-dim: rgba(255,126,8,.10);
  --metodologia-black: #000000;
  --metodologia-white: #FFFFFF;
  --metodologia-light: #EFEAE4;
  ...
  --metodologia-positive-text: #B8860B;
...
@media (prefers-color-scheme: dark) {
  ...
  /* When implemented, create --metodologia-*-dark variants for semantic colors */
}
```
