...
> Ejecuta el skill **html-brand** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **html-brand** dentro del pipeline de discovery de MetodologIA.
