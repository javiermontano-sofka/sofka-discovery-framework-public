...
description: "Multi-domain technology maturity scorecard"
nlhp-version: "3.0"
---

# Maturity Assessment

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-maturity-assessment`

## Invocación

```
Analiza {} usando el skill maturity-assessment.
...
Multi-domain technology maturity scorecard. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
