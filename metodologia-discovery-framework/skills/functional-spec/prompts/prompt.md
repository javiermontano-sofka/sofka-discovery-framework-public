...
> Ejecuta el skill **functional-spec** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **functional-spec** dentro del pipeline de discovery de MetodologIA.
...
Skill: `functional-spec/SKILL.md`
