...
> Ejecuta el skill **stakeholder-mapping** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **stakeholder-mapping** dentro del pipeline de discovery de MetodologIA.
...
Skill: `stakeholder-mapping/SKILL.md`
