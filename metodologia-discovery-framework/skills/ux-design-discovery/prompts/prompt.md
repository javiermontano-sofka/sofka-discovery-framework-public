...
> Ejecuta el skill **ux-design-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **ux-design-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `ux-design-discovery/SKILL.md`
