...
> Ejecuta el skill **rpa-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **rpa-discovery** dentro del pipeline de discovery de MetodologIA.
