...
> Ejecuta el skill **mermaid-diagramming** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **mermaid-diagramming** dentro del pipeline de discovery de MetodologIA.
...
Skill: `mermaid-diagramming/SKILL.md`
