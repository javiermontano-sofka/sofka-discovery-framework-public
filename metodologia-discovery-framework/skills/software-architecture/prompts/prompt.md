...
> Ejecuta el skill **software-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **software-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `software-architecture/SKILL.md`
