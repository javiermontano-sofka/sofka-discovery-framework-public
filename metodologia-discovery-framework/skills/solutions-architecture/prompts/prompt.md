...
> Ejecuta el skill **solutions-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **solutions-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `solutions-architecture/SKILL.md`
