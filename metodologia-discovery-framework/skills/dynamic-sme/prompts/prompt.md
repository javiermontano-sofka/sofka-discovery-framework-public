...
id: dynamic-sme
title: "Dynamic SME"
description: "Context-adaptive industry expert for sector intelligence"
nlhp-version: "3.0"
---

# Dynamic SME

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-dynamic-sme`

## Invocación

```
Analiza {} usando el skill dynamic-sme.
...
Context-adaptive industry expert for sector intelligence. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
