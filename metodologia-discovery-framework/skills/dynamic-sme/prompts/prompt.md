...
> Ejecuta el skill **dynamic-sme** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **dynamic-sme** dentro del pipeline de discovery de MetodologIA.
