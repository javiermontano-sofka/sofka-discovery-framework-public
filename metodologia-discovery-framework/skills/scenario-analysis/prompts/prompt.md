...
> Ejecuta el skill **scenario-analysis** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **scenario-analysis** dentro del pipeline de discovery de MetodologIA.
...
Skill: `scenario-analysis/SKILL.md`
