...
> Ejecuta el skill **devsecops-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **devsecops-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `devsecops-architecture/SKILL.md`
