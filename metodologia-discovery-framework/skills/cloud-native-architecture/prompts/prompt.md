...
> Ejecuta el skill **cloud-native-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **cloud-native-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `cloud-native-architecture/SKILL.md`
