...
> Ejecuta el skill **testing-strategy** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **testing-strategy** dentro del pipeline de discovery de MetodologIA.
