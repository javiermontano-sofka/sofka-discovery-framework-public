...
> Ejecuta el skill **asis-analysis** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **asis-analysis** dentro del pipeline de discovery de MetodologIA.
