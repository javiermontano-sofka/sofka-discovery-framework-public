...
id: poc-lab
title: "PoC Lab"
description: "Proof of concept design with hypothesis-driven validation"
nlhp-version: "3.0"
---

# PoC Lab

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-poc-lab`

## Invocación

```
Analiza {} usando el skill poc-lab.
...
Proof of concept design with hypothesis-driven validation. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
