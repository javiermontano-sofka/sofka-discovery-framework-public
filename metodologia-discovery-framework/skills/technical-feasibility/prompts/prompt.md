...
> Ejecuta el skill **technical-feasibility** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **technical-feasibility** dentro del pipeline de discovery de MetodologIA.
...
Skill: `technical-feasibility/SKILL.md`
