---
id: mini-apps-discovery
title: "Mini-Apps Discovery"
description: "Bounded context mapping and micro-frontend extraction"
nlhp-version: "3.0"
---

# Mini-Apps Discovery

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-mini-apps-discovery`

## Invocación

```
Analiza {} usando el skill mini-apps-discovery.
...
Bounded context mapping and micro-frontend extraction. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
