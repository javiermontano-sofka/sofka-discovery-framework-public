...
> Ejecuta el skill **mini-apps-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **mini-apps-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `mini-apps-discovery/SKILL.md`
