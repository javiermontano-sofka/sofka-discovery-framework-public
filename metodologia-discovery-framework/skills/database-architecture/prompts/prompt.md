...
> Ejecuta el skill **database-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **database-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `database-architecture/SKILL.md`
