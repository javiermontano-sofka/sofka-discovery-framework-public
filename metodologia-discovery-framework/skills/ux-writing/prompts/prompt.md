...
> Ejecuta el skill **ux-writing** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **ux-writing** dentro del pipeline de discovery de MetodologIA.
