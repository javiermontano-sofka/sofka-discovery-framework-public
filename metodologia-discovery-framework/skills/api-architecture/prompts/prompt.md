...
> Ejecuta el skill **api-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **api-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `api-architecture/SKILL.md`
