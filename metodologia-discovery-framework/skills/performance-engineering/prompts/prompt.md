...
> Ejecuta el skill **performance-engineering** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **performance-engineering** dentro del pipeline de discovery de MetodologIA.
...
Skill: `performance-engineering/SKILL.md`
