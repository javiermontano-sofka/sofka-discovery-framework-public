...
> Ejecuta el skill **cloud-migration** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **cloud-migration** dentro del pipeline de discovery de MetodologIA.
...
Skill: `cloud-migration/SKILL.md`
