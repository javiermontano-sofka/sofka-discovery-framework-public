...
> Ejecuta el skill **qa-service-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **qa-service-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `qa-service-discovery/SKILL.md`
