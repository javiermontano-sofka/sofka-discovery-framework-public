...
> Ejecuta el skill **cloud-service-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **cloud-service-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `cloud-service-discovery/SKILL.md`
