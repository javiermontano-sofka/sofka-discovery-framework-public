...
> Ejecuta el skill **ai-center-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **ai-center-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `ai-center-discovery/SKILL.md`
