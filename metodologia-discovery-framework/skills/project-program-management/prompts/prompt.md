...
> Ejecuta el skill **project-program-management** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **project-program-management** dentro del pipeline de discovery de MetodologIA.
...
Skill: `project-program-management/SKILL.md`
