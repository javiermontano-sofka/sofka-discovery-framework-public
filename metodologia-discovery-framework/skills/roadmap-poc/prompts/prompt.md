...
> Ejecuta el skill **roadmap-poc** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **roadmap-poc** dentro del pipeline de discovery de MetodologIA.
