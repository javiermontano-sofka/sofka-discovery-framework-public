...
> Ejecuta el skill **enterprise-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **enterprise-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `enterprise-architecture/SKILL.md`
