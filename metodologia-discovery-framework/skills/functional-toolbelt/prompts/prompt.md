...
> Ejecuta el skill **functional-toolbelt** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **functional-toolbelt** dentro del pipeline de discovery de MetodologIA.
...
Skill: `functional-toolbelt/SKILL.md`
