...
> Ejecuta el skill **mobile-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **mobile-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `mobile-architecture/SKILL.md`
