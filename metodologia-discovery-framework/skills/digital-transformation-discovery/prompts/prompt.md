---
id: digital-transformation-discovery
title: "Digital Transformation Discovery"
description: "Digital maturity model and transformation roadmap"
nlhp-version: "3.0"
---

# Digital Transformation Discovery

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-digital-transformation-discovery`

## Invocación

```
Analiza {} usando el skill digital-transformation-discovery.
...
Digital maturity model and transformation roadmap. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
