...
> Ejecuta el skill **commercial-model** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **commercial-model** dentro del pipeline de discovery de MetodologIA.
...
Skill: `commercial-model/SKILL.md`
