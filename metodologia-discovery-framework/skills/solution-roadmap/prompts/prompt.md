...
> Ejecuta el skill **solution-roadmap** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **solution-roadmap** dentro del pipeline de discovery de MetodologIA.
...
Skill: `solution-roadmap/SKILL.md`
