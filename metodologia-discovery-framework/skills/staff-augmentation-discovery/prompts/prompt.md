...
> Ejecuta el skill **staff-augmentation-discovery** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **staff-augmentation-discovery** dentro del pipeline de discovery de MetodologIA.
...
Skill: `staff-augmentation-discovery/SKILL.md`
