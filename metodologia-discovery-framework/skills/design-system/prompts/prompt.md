...
> Ejecuta el skill **design-system** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **design-system** dentro del pipeline de discovery de MetodologIA.
