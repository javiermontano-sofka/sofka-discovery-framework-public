...
> Ejecuta el skill **executive-pitch** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **executive-pitch** dentro del pipeline de discovery de MetodologIA.
...
Skill: `executive-pitch/SKILL.md`
