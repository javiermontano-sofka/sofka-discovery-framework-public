...
> Ejecuta el skill **bi-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **bi-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `bi-architecture/SKILL.md`
