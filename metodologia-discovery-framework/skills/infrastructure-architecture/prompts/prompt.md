...
> Ejecuta el skill **infrastructure-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **infrastructure-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `infrastructure-architecture/SKILL.md`
