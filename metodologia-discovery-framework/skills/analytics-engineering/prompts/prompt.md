...
> Ejecuta el skill **analytics-engineering** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **analytics-engineering** dentro del pipeline de discovery de MetodologIA.
...
Skill: `analytics-engineering/SKILL.md`
