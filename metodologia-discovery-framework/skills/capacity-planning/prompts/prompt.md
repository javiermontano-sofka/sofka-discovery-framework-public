...
description: "Infrastructure capacity assessment and growth projection"
nlhp-version: "3.0"
---

# Capacity Planning

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-capacity-planning`

## Invocación

```
Analiza {} usando el skill capacity-planning.
...
Infrastructure capacity assessment and growth projection. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
