...
> Ejecuta el skill **discovery-orchestrator** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **discovery-orchestrator** dentro del pipeline de discovery de MetodologIA.
...
Skill: `discovery-orchestrator/SKILL.md`
