...
> Ejecuta el skill **event-architecture** sobre el contexto actual del proyecto.
...
Este prompt activa el skill **event-architecture** dentro del pipeline de discovery de MetodologIA.
...
Skill: `event-architecture/SKILL.md`
