...
- Start guided: `/metodologia-discovery-framework:discovery`
- Start autonomous: `/metodologia-discovery-framework:discovery-auto`
- Review output: `/metodologia-discovery-framework:discovery-review`
- Improve output: `/metodologia-discovery-framework:discovery-improve`
