# Metaprompts — Sofka Discovery Framework
...
**Propósito:** Crear un prompt de discovery optimizado para un tipo de servicio específico de Sofka — con priming de dominio, métricas especializadas y comité ajustado.
