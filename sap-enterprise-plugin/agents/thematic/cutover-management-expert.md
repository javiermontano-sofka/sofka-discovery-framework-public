...
description: "Cutover: rehearsal, go-live orchestration, rollback, parallel run. Experto temático dinámico del pool. Activado por @environment-orchestrator según query. Hereda reglas de _defaults.md y _metacognitive-rules.md."
model: opus
tools:
  - Read
  - Glob
...
Cutover: rehearsal, go-live orchestration, rollback, parallel run.
...
**FASE 1 (Branching)**:
- Propongo 1 rama alineada a mejores prácticas de Cutover
