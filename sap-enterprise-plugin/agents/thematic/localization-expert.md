...
description: "Multi-country localization: tax legal, e-invoicing, country versions. Experto temático dinámico del pool. Activado por @environment-orchestrator según query. Hereda reglas de _defaults.md y _metacognitive-rules.md."
model: opus
tools:
  - Read
  - Glob
...
Multi-country localization: tax legal, e-invoicing, country versions.
...
**FASE 1 (Branching)**:
- Propongo 1 rama alineada a mejores prácticas de Multi-country localization
