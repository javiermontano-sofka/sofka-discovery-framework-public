...
description: "Industry: IT services, consulting, professional services (HENKA-like patterns). Experto temático dinámico del pool. Activado por @environment-orchestrator según query. Hereda reglas de _defaults.md y _metacognitive-rules.md."
model: opus
tools:
  - Read
  - Glob
...
Industry: IT services, consulting, professional services (HENKA-like patterns).
