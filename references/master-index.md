...
- Rutas absolutas desde `~/skills/plugins/sofka-discovery-framework/` (alias: `$SDF`)
...
| LICENSE | Text | `$SDF/LICENSE` | priming-rag-plugin-infrastructure.md | Licencia propietaria Sofka Technologies | #licencia #legal #propietario |
...
| landing.html | HTML | `$SDF/landing.html` | priming-rag-html-assets.md | Landing page del plugin, Sofka Design System v5 | #html #landing #branding |
...
| priming-rag-sofka-corporate.md | RAG | `$SDF/references/priming-rag/priming-rag-sofka-corporate.md` | (self) | Informacion corporativa Sofka | #sofka #corporativo #empresa |
| priming-rag-ai-center.md | RAG | `$SDF/references/priming-rag/priming-rag-ai-center.md` | (self) | Centro de IA Sofka | #ia #centro #sofka |
...
| priming-rag-certifications.md | RAG | `$SDF/references/priming-rag/priming-rag-certifications.md` | (self) | Certificaciones Sofka | #certificaciones #talento #skills |
...
|-------|------|------|---------|---------|------|
| landing.html | HTML | `$SDF/landing.html` | priming-rag-html-assets.md | Landing page Sofka SAGE, Design System v5 | #landing #html #branding |
...
|---------|------|------|---------|----------|------|
| sofka-adoption-strategy.skill | ZIP | `~/skills/sofka-skills/sofka-adoption-strategy.skill` | priming-rag-global-ecosystem.md | Estrategia de adopcion | #adopcion #package |
| sofka-analytics-engineering.skill | ZIP | `~/skills/sofka-skills/sofka-analytics-engineering.skill` | priming-rag-global-ecosystem.md | Analytics engineering | #analytics #package |
| sofka-api-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-api-architecture.skill` | priming-rag-global-ecosystem.md | API architecture | #api #package |
| sofka-architecture-tobe.skill | ZIP | `~/skills/sofka-skills/sofka-architecture-tobe.skill` | priming-rag-global-ecosystem.md | Architecture TO-BE | #tobe #package |
| sofka-asis-analysis.skill | ZIP | `~/skills/sofka-skills/sofka-asis-analysis.skill` | priming-rag-global-ecosystem.md | AS-IS analysis | #asis #package |
| sofka-bi-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-bi-architecture.skill` | priming-rag-global-ecosystem.md | BI architecture | #bi #package |
| sofka-change-readiness-assessment.skill | ZIP | `~/skills/sofka-skills/sofka-change-readiness-assessment.skill` | priming-rag-global-ecosystem.md | Change readiness | #cambio #package |
| sofka-cloud-migration.skill | ZIP | `~/skills/sofka-skills/sofka-cloud-migration.skill` | priming-rag-global-ecosystem.md | Cloud migration | #cloud #package |
| sofka-cloud-native-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-cloud-native-architecture.skill` | priming-rag-global-ecosystem.md | Cloud native | #cloudnative #package |
| sofka-commercial-model.skill | ZIP | `~/skills/sofka-skills/sofka-commercial-model.skill` | priming-rag-global-ecosystem.md | Commercial model | #comercial #package |
| sofka-copywriting.skill | ZIP | `~/skills/sofka-skills/sofka-copywriting.skill` | priming-rag-global-ecosystem.md | Copywriting | #copywriting #package |
| sofka-cost-estimation.skill | ZIP | `~/skills/sofka-skills/sofka-cost-estimation.skill` | priming-rag-global-ecosystem.md | Cost estimation | #costos #package |
| sofka-data-engineering.skill | ZIP | `~/skills/sofka-skills/sofka-data-engineering.skill` | priming-rag-global-ecosystem.md | Data engineering | #datos #package |
| sofka-data-governance.skill | ZIP | `~/skills/sofka-skills/sofka-data-governance.skill` | priming-rag-global-ecosystem.md | Data governance | #gobernanza #package |
| sofka-data-mesh-strategy.skill | ZIP | `~/skills/sofka-skills/sofka-data-mesh-strategy.skill` | priming-rag-global-ecosystem.md | Data mesh | #datamesh #package |
| sofka-data-science-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-data-science-architecture.skill` | priming-rag-global-ecosystem.md | Data science | #datascience #package |
| sofka-data-storytelling.skill | ZIP | `~/skills/sofka-skills/sofka-data-storytelling.skill` | priming-rag-global-ecosystem.md | Data storytelling | #storytelling #package |
| sofka-data-viz-storytelling.skill | ZIP | `~/skills/sofka-skills/sofka-data-viz-storytelling.skill` | priming-rag-global-ecosystem.md | Data viz storytelling | #dataviz #package |
| sofka-database-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-database-architecture.skill` | priming-rag-global-ecosystem.md | Database architecture | #database #package |
| sofka-design-system.skill | ZIP | `~/skills/sofka-skills/sofka-design-system.skill` | priming-rag-global-ecosystem.md | Design system | #design #package |
| sofka-devsecops-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-devsecops-architecture.skill` | priming-rag-global-ecosystem.md | DevSecOps | #devsecops #package |
| sofka-discovery-handover.skill | ZIP | `~/skills/sofka-skills/sofka-discovery-handover.skill` | priming-rag-global-ecosystem.md | Discovery handover | #handover #package |
| sofka-discovery-orchestrator.skill | ZIP | `~/skills/sofka-skills/sofka-discovery-orchestrator.skill` | priming-rag-global-ecosystem.md | Discovery orchestrator | #orquestacion #package |
| sofka-enterprise-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-enterprise-architecture.skill` | priming-rag-global-ecosystem.md | Enterprise architecture | #enterprise #package |
| sofka-event-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-event-architecture.skill` | priming-rag-global-ecosystem.md | Event architecture | #eventos #package |
| sofka-execution-burndown.skill | ZIP | `~/skills/sofka-skills/sofka-execution-burndown.skill` | priming-rag-global-ecosystem.md | Execution burndown | #burndown #package |
| sofka-executive-pitch.skill | ZIP | `~/skills/sofka-skills/sofka-executive-pitch.skill` | priming-rag-global-ecosystem.md | Executive pitch | #pitch #package |
| sofka-finops.skill | ZIP | `~/skills/sofka-skills/sofka-finops.skill` | priming-rag-global-ecosystem.md | FinOps | #finops #package |
| sofka-flow-mapping.skill | ZIP | `~/skills/sofka-skills/sofka-flow-mapping.skill` | priming-rag-global-ecosystem.md | Flow mapping | #flujos #package |
| sofka-functional-spec.skill | ZIP | `~/skills/sofka-skills/sofka-functional-spec.skill` | priming-rag-global-ecosystem.md | Functional spec | #spec #package |
| sofka-hypothesis-driven-development.skill | ZIP | `~/skills/sofka-skills/sofka-hypothesis-driven-development.skill` | priming-rag-global-ecosystem.md | Hypothesis-driven dev | #hipotesis #package |
| sofka-infrastructure-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-infrastructure-architecture.skill` | priming-rag-global-ecosystem.md | Infrastructure arch | #infraestructura #package |
| sofka-input-analysis.skill | ZIP | `~/skills/sofka-skills/sofka-input-analysis.skill` | priming-rag-global-ecosystem.md | Input analysis | #inputs #package |
| sofka-mobile-platform-assessment.skill | ZIP | `~/skills/sofka-skills/sofka-mobile-platform-assessment.skill` | priming-rag-global-ecosystem.md | Mobile platform assessment | #mobile #package |
| sofka-multidimensional-feasibility.skill | ZIP | `~/skills/sofka-skills/sofka-multidimensional-feasibility.skill` | priming-rag-global-ecosystem.md | Multidimensional feasibility | #factibilidad #package |
| sofka-observability.skill | ZIP | `~/skills/sofka-skills/sofka-observability.skill` | priming-rag-global-ecosystem.md | Observability | #observabilidad #package |
| sofka-output-engineering.skill | ZIP | `~/skills/sofka-skills/sofka-output-engineering.skill` | priming-rag-global-ecosystem.md | Output engineering | #output #package |
| sofka-performance-engineering.skill | ZIP | `~/skills/sofka-skills/sofka-performance-engineering.skill` | priming-rag-global-ecosystem.md | Performance engineering | #performance #package |
| sofka-pipeline-governance.skill | ZIP | `~/skills/sofka-skills/sofka-pipeline-governance.skill` | priming-rag-global-ecosystem.md | Pipeline governance | #pipeline #package |
| sofka-quality-engineering.skill | ZIP | `~/skills/sofka-skills/sofka-quality-engineering.skill` | priming-rag-global-ecosystem.md | Quality engineering | #calidad #package |
| sofka-risk-controlling-dynamics.skill | ZIP | `~/skills/sofka-skills/sofka-risk-controlling-dynamics.skill` | priming-rag-global-ecosystem.md | Risk controlling | #riesgos #package |
| sofka-roadmap-poc.skill | ZIP | `~/skills/sofka-skills/sofka-roadmap-poc.skill` | priming-rag-global-ecosystem.md | Roadmap PoC | #roadmap #package |
| sofka-scenario-analysis.skill | ZIP | `~/skills/sofka-skills/sofka-scenario-analysis.skill` | priming-rag-global-ecosystem.md | Scenario analysis | #escenarios #package |
| sofka-sector-intelligence.skill | ZIP | `~/skills/sofka-skills/sofka-sector-intelligence.skill` | priming-rag-global-ecosystem.md | Sector intelligence | #sector #package |
| sofka-security-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-security-architecture.skill` | priming-rag-global-ecosystem.md | Security architecture | #seguridad #package |
| sofka-software-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-software-architecture.skill` | priming-rag-global-ecosystem.md | Software architecture | #software #package |
| sofka-software-viability.skill | ZIP | `~/skills/sofka-skills/sofka-software-viability.skill` | priming-rag-global-ecosystem.md | Software viability | #viabilidad #package |
| sofka-solution-roadmap.skill | ZIP | `~/skills/sofka-skills/sofka-solution-roadmap.skill` | priming-rag-global-ecosystem.md | Solution roadmap | #solucion #package |
| sofka-solutions-architecture.skill | ZIP | `~/skills/sofka-skills/sofka-solutions-architecture.skill` | priming-rag-global-ecosystem.md | Solutions architecture | #soluciones #package |
| sofka-stakeholder-mapping.skill | ZIP | `~/skills/sofka-skills/sofka-stakeholder-mapping.skill` | priming-rag-global-ecosystem.md | Stakeholder mapping | #stakeholders #package |
| sofka-storytelling.skill | ZIP | `~/skills/sofka-skills/sofka-storytelling.skill` | priming-rag-global-ecosystem.md | Storytelling | #storytelling #package |
| sofka-technical-feasibility.skill | ZIP | `~/skills/sofka-skills/sofka-technical-feasibility.skill` | priming-rag-global-ecosystem.md | Technical feasibility | #factibilidad #package |
| sofka-technical-writing.skill | ZIP | `~/skills/sofka-skills/sofka-technical-writing.skill` | priming-rag-global-ecosystem.md | Technical writing | #escritura #package |
| sofka-technology-vigilance.skill | ZIP | `~/skills/sofka-skills/sofka-technology-vigilance.skill` | priming-rag-global-ecosystem.md | Technology vigilance | #tecnologia #package |
| sofka-testing-strategy.skill | ZIP | `~/skills/sofka-skills/sofka-testing-strategy.skill` | priming-rag-global-ecosystem.md | Testing strategy | #testing #package |
| sofka-user-representative.skill | ZIP | `~/skills/sofka-skills/sofka-user-representative.skill` | priming-rag-global-ecosystem.md | User representative | #usuario #package |
| sofka-ux-writing.skill | ZIP | `~/skills/sofka-skills/sofka-ux-writing.skill` | priming-rag-global-ecosystem.md | UX writing | #ux #package |
| sofka-workshop-design.skill | ZIP | `~/skills/sofka-skills/sofka-workshop-design.skill` | priming-rag-global-ecosystem.md | Workshop design | #workshop #package |

### Additional Packages

| Package | Tipo | Ruta | RAG Doc | Utilidad | Tags |
|---------|------|------|---------|----------|------|
| sofka-discovery-framework.plugin | ZIP | `~/skills/sofka-skills/sofka-discovery-framework.plugin` | priming-rag-global-ecosystem.md | Plugin completo empaquetado | #plugin #package #completo |
| sofka-discovery-skills.zip | ZIP | `~/skills/sofka-skills/sofka-discovery-skills.zip` | priming-rag-global-ecosystem.md | Bundle de skills de discovery | #bundle #skills #zip |
