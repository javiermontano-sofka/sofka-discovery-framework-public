...
Este documento permite a cualquier agente comprender la estructura fundamental del plugin, su configuracion operativa, y las reglas de activacion. Es el primer documento a consultar cuando se necesita entender "como funciona SAGE".
...
sofka-discovery-framework/
  ...
  LICENSE                — All Rights Reserved, Sofka Technologies
...
- **Prefijo tecnico:** `/sdf:` (backward-compatible con `sofka-discovery-framework:`)
...
- **Licencia:** All Rights Reserved, Sofka Technologies
- **Colores:** Primary #FF7E08, Dark #1A1A2E, Success #FFD700 (NUNCA verde)
...
- "Que tipos de servicio soporta SAGE?" -> Seccion Service Type Routing
...
- "Que colores usa Sofka?" -> Seccion Licencia y branding
