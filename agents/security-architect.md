...
| Skill | Function |
|---|---|
| `sofka-security-architecture` | Zero trust design, threat modeling (STRIDE), security controls, compliance assessment |
| `sofka-devsecops-architecture` | CI/CD security pipeline, SLSA compliance, SAST/DAST/SCA, secrets management, DORA security metrics |
