...
> **Skill:** sofka-data-engineering
> **Autor:** Javier Montaño | **Fecha:** 13 de marzo de 2026
> **Licencia:** (c) Sofka Technologies — All Rights Reserved

---

## Instrucciones de Uso

Cada prompt está diseñado para invocarse con el skill `sofka-data-engineering`. Reemplaza los valores entre `{llaves}` con el contexto del proyecto. Los prompts pueden combinarse secuencialmente o usarse de forma independiente.
