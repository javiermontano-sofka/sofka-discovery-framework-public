...
**Prompt:**
```
/sdf:roadmap {PROYECTO} {DURACIÓN} {RANGO_PRESUPUESTO} {VARIANTE}=ejecutiva {FORMATO}=html
...
Organizaciones involucradas: {ORGANIZACIONES} (cliente, Sofka, vendors).
...
**Prompt:**
```
/sdf:roadmap {PROYECTO} 12 under2m
...
**Prompt:**
```
/sdf:roadmap {PROYECTO} {DURACIÓN} {PRESUPUESTO}
