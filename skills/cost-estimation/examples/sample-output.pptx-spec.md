...
| Color acento | #FF7E08 (Sofka primary) |
| Color exito | #FFD700 (NUNCA verde) |
| Color alerta | #FF4444 |
...
- Nivel 2: Features por epic (sub-bloques, color #FF7E08 con opacidad variable segun complejidad)
...
- Eje Y: FTE-Meses
- Segmentos por seniority: Junior (#FFD700), Mid (#FF7E08), Senior (#1A1A2E), Principal (#FF4444)
...
- Cada barra muestra: rango optimista (linea delgada), probable (barra solida #FF7E08), pesimista (linea delgada)
- Hitos clave marcados con diamantes (#FFD700)
...
- Barras en gradiente #1A1A2E → #FF7E08
- Lineas verticales marcando: P50 (punteada), P80 (solida #FFD700, gruesa), P95 (punteada roja)
...
- Estrella #FFD700 en la opcion recomendada
...
3. **Master slide**: Incluir logo Sofka en esquina superior derecha, footer con disclaimer en todas las slides.
