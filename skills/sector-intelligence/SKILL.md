---
name: sofka-sector-intelligence
...
`sofka-sector-intelligence` connects with `sofka-technology-vigilance` to provide industry-contextualized technology signals:
...
```
sofka-sector-intelligence (industry context)
    ↓
sofka-technology-vigilance (technology signals filtered by sector)
    ↓
technology-scout (evaluation of proposed technologies)
    ↓
sofka-multidimensional-feasibility (Think Tank validation)
```
