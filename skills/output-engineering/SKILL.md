...
3. **Brand compliance is non-negotiable.** Sofka Design System v4 in every pixel of every format.
...
| Footer | © Sofka Technologies, date, page number |
...
| Cover page | Project name, date, version, Sofka logo |
...
| Element | Standard |
|---------|----------|
| Slide master | Sofka brand template |
...
- **Client without Sofka brand permission**: Degrade gracefully to neutral styling.
