# Especificacion de Plantilla PPTX — Sofka Technologies

> Referencia definitiva para la produccion de presentaciones PPTX con branding Sofka.
...
| Token | Hex | Uso |
|-------|-----|-----|
| Primary | #FF7E08 | Acentos, barras, CTAs, highlights |
| Dark | #1A1A2E | Fondos oscuros, texto principal, headers |
| Success | #FFD700 | Estados positivos, aprobados, gold |
...
**Regla critica:** NUNCA usar verde (#00XX00) para estados positivos. Usar gold (#FFD700).
...
[Barra lateral izquierda: 8px ancho, #FF7E08, height completa]

[x: 2cm, y: 3cm]
SOFKA.                              ← Clash Grotesk Bold 18pt, #FFFFFF, "." en #FF7E08
...
[x: 2cm, y: 14cm]
[Linea: 4cm ancho, 2pt, #FF7E08]

[x: 2cm, y: 15cm]
{Fecha}  |  {Version}  |  Confidencial   ← Inter Regular 12pt, #6B7280

[Footer: barra inferior 4px #FF7E08]
```
...
[Barra superior: height 60px, #1A1A2E]
  ...
  [x: derecha - 1.5cm]
  SOFKA.                             ← Clash Grotesk Regular 10pt, #9CA3AF

[Linea de acento: 3px, #FF7E08, debajo de la barra]
...
[Footer: y: 17.5cm, height: 1.5cm, fondo: transparente]
  [Izquierda] (c) Sofka Technologies    ← Inter Regular 9pt, #9CA3AF
...
| Datos numericos destacados | Clash Grotesk | 36pt | #FF7E08 | Bold |
...
|-----------|-------|-------|
| Score 8-10 / Positivo | #FFD700 | #1A1A2E |
...
[Rectangulo redondeado: auto-width, height 28px, radius 14px]
  ...
  Variantes:
    Recomendado: fondo #FEF3C7, texto #B45309, borde 1pt #FFD700
...
| Ancho maximo | 1200px |
| Fondo | Transparente |
| Tema Mermaid | base, con variables Sofka |
| Variables | primaryColor: #FF7E08, primaryTextColor: #1A1A2E, lineColor: #1A1A2E |
...
[Izquierda: x: 1.5cm]
(c) Sofka Technologies               ← Inter Regular 9pt, #9CA3AF
...
- **Score grande:** "7.8/10" en Clash Grotesk 48pt #FFD700
...
- [ ] Titulo slide con branding Sofka correcto (#1A1A2E fondo, #FF7E08 acento)
...
- [ ] Paleta de colores Sofka respetada
- [ ] Gold (#FFD700) para positivo, NUNCA verde
...
- [ ] (c) Sofka Technologies en footer
