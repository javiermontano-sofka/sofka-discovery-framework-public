# Especificacion de Plantilla DOCX — Sofka Technologies

> Referencia definitiva para la produccion de documentos DOCX con branding Sofka.
...
SOFKA.                              ← Clash Grotesk Bold 36pt, #1A1A2E, "." en #FF7E08
...
| H2 (Titulo 2) | Clash Grotesk | 18pt | #FF7E08 | Semi-Bold (600) | 18pt | 8pt |
...
| Hipervinculo | Inter Regular 11pt, #FF7E08, subrayado |
...
| Borde inferior | 2pt solido #FF7E08 |
...
| Borde superior | 2pt solido #FF7E08 |
...
|-------------------|---------------------|----------------|---------------|
| Score alto (8-10) | #FFD700 (gold) | #1A1A2E | Valor numerico |
| Score medio (5-7) | #FEF3C7 (ambar claro) | #B45309 | Valor numerico |
| Score bajo (1-4) | #FEE2E2 (rojo claro) | #EF4444 | Valor numerico |

**Regla critica:** NUNCA usar verde (#00XX00) para estados positivos. El sistema Sofka usa gold (#FFD700) como color de exito.
...
|-----------|-------|
| Fondo | #FEF3C7 |
| Borde izquierdo | 4pt solido #FFD700 |
...
CONFIDENCIAL                   {Nombre del Proyecto}     [Logo Sofka 24px]
...
```
[Izquierda]                    [Centro]                  [Derecha]
(c) Sofka Technologies         {DD-MMM-YYYY}             Pagina X de Y
...
pandoc "{input}.md" \
  ...
  --to=docx \
  --reference-doc=sofka-reference.docx \
  --toc \
  --toc-depth=3 \
  --highlight-style=tango \
  --metadata title="{TITULO}" \
  --metadata author="Sofka Technologies" \
  --metadata date="{FECHA}" \
...
- `sofka-reference.docx` contiene todos los estilos definidos en esta especificacion
...
- "2. Escenarios Evaluados" — H2, Clash Grotesk 18pt #FF7E08
...
| Impacto Negocio | **8** (celda #FFD700) | Valor entregado desde sprint 3 **[DOC]** |
| Riesgo | **8** (celda #FFD700) | Riesgo controlado: rollback granular por modulo **[CONFIG]** |
| Factibilidad | **9** (celda #FFD700) | Equipo actual puede iniciar con capacitacion minima **[STAKEHOLDER]** |
| Tiempo | **8** (celda #FFD700) | Quick wins en 3 meses, migracion completa en 12 **[INFERENCIA]** |
...
**Callout Insight:**
```
[Caja: fondo #FEF3C7, borde izquierdo 4pt #FFD700]
...
- [ ] H2 en Clash Grotesk 18pt #FF7E08
...
*Especificacion mantenida por el equipo PreSales de Sofka Technologies.*
*(c) Sofka Technologies — Todos los derechos reservados.*
