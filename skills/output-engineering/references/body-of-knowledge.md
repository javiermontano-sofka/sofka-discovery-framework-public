...
| **Brand Compliance** | Adherencia a los 7 elementos del Sofka Design System: color primario, color oscuro, color éxito (gold, nunca verde), logo, footer, tipografía, disclaimer. |
...
| **Semaphore Colors** | Sistema de indicadores visuales (verde/amarillo/rojo) que en el contexto Sofka usa gold (#FFD700) para positivo, nunca verde. |
