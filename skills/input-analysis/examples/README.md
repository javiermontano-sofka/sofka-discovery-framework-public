...
> **Skill:** input-analysis | **Framework:** Sofka Discovery Framework
...
| [`sample-output.html`](sample-output.html) | HTML (Sofka Design System v4) | Misma información en formato presentable | Liderazgo, stakeholders, demos internas |
...
- **Ventajas:** Visualmente pulido, responsive, imprimible, Sofka-branded.
- **Estándar:** Design System v4 — colores primario (#FF7E08), oscuro (#1A1A2E), success (#FFD700). Tipografía Inter. Sin verde para estados de éxito.

---

## Qué Demuestra el Ejemplo

El ejemplo procesa un input real de un escenario de pre-sales discovery en Sofka:
