...
**Impacto en el skill:**
- El skill se cruza directamente con sofka-design-system. La convergencia sugiere que cada componente del design system deberia incluir sus UX writing patterns (labels, placeholders, error messages, help text).
...
**Autor:** Javier Montano | **Ultima actualizacion:** 13 de marzo de 2026 | (c) Sofka Technologies
