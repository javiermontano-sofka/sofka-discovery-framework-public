...
- **sofka-cloud-architecture:** Cloud infrastructure that provides scaling capabilities
- **sofka-observability:** Monitoring data that feeds capacity models
- **sofka-sla-design:** SLO targets that define minimum acceptable capacity
