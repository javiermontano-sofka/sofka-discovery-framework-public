...
Prompts listos para usar en escenarios reales de discovery y gestión de stakeholders. Cada prompt está diseñado para invocarse directamente en una sesión de trabajo con el Sofka Discovery Framework.
...
**Nombre:** RACI completo para el pipeline de discovery de Sofka
...
Stakeholders Sofka: [LISTA DEL EQUIPO SOFKA]
...
4. Dueño de la comunicación (rol de Sofka o del cliente)
