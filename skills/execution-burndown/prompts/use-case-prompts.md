...
Analizar:
1. Velocidad actual vs. modelo Sofka (1 FTE/feature/dia desde Sprint 2)
...
- Curva de ramp-up del nuevo developer (Sofka ramp-up model)
...
Analizar:
1. Velocidad real vs. modelo Sofka (1 FTE/feature/dia): % de cumplimiento
...
- Calibracion del modelo: ¿el equipo opera al X% del modelo Sofka?
...
- Todos los prompts asumen modelo Sofka: 1 FTE = 1 feature/dia (Sprint 2+), ramp-up Sprint 1 = 0.5x
