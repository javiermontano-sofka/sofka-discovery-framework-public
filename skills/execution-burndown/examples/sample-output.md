...
- Sprint 2-10: velocidad estabilizada en ~3.8 features/dia equipo (95% del modelo Sofka)
...
| SP maximo por feature | 3 SP | [CONFIG] Regla Sofka: ≤3 SP |
| Modelo de productividad | 1 feature/dia/FTE (desde Sprint 2) | [BENCHMARK] Sofka Productivity Model |
| Sprint 1 ramp-up factor | 0.5x | [BENCHMARK] Curva de onboarding Sofka |
...
> 💡 **Regla Sofka:** Ninguna feature >3 SP entra al backlog ejecutable. Las 12 features originales >3 SP fueron re-descompuestas en Sprint 0, generando las 80 features finales.
...
|---------|-------|-------------|
| Velocidad promedio (Sprint 2+) | 3.78 features/dia | 94.4% del modelo Sofka |
...
1. **El equipo opera al 94.4% del modelo Sofka (Sprint 2+).** [BENCHMARK] La velocidad de 3.78 features/dia para 4 developers esta dentro del rango esperado. No hay problema estructural de productividad.
...
**Generado por:** Sofka Discovery Framework — execution-burndown
