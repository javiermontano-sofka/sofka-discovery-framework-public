...
| Regla | Rango | Formato |
|-------|-------|---------|
| pct_of_total > 15% | H:H | Bold + fill amarillo (#FFD700) |
...
| Regla | Rango | Formato |
|-------|-------|---------|
| monthly_waste_high > $5,000 | G:G | Bold + fill amarillo (#FFD700) |
...
| Regla | Rango | Formato |
|-------|-------|---------|
| tier = "Quick Win" | B:B | Fill amarillo (#FFD700) |
| tier = "Strategic" | B:B | Fill azul claro (#BBDEFB) |
| status = "Completed" | L:L | Fill verde claro + strikethrough |
| annual_savings_high > $50,000 | G:G | Bold + fill amarillo (#FFD700) |
...
| status = "Expiring Soon" | L:L | Fill amarillo (#FFD700) |
...
| KPI | Green (#C8E6C9) | Yellow (#FFD700) | Red (#FFCDD2) |
|-----|----------------|-----------------|---------------|
| Waste % | <15% | 15-30% | >30% |
