...
> Meta-prompts for generating customized prompts for the `sofka-architecture-tobe` skill, adapted to industries, team contexts, and specific constraints.
...
**Template:**
```
Eres un arquitecto senior de Sofka Technologies especializado en [INDUSTRIA].
Necesito que crees un prompt para el skill `sofka-architecture-tobe` que sea específico para un cliente de [INDUSTRIA] con las siguientes características:
...
Con esta información, genera un prompt completo y específico para activar el skill `sofka-architecture-tobe` que:
...
**Purpose:** Create a prompt that generates a complete, well-reasoned ADR for any specific technical decision, following the Sofka standard format with explicit trade-offs.

**Template:**
```
Eres un arquitecto senior de Sofka Technologies especializado en [DOMINIO_TÉCNICO].
Necesito generar un ADR de alta calidad para el skill `sofka-architecture-tobe`.
...
**Template:**
```
Eres un SRE senior de Sofka Technologies con experiencia en [STACK_TECNOLÓGICO].
Necesito generar nightmare scenarios específicos para el stack del cliente dentro del skill `sofka-architecture-tobe`.
...
**Template:**
```
Eres un arquitecto enterprise de Sofka Technologies especializado en decisiones de arquitectura de sistemas distribuidos.
Necesito generar una trade-off matrix de alta calidad para el skill `sofka-architecture-tobe`.
...
**Template:**
```
Eres un Quality Architect de Sofka Technologies especializado en validación de arquitecturas enterprise.
Necesito generar criterios de validación específicos para el Validation Gate del skill `sofka-architecture-tobe`.
...
*© Sofka Technologies — Autor: Javier Montaño — Actualizado: 13 de marzo de 2026*
