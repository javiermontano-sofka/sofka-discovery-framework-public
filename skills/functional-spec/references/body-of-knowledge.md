...
La entrevista con stakeholders es la técnica más efectiva para capturar requisitos tácitos. El Sofka Discovery Framework los recoge durante Phase 0 (Stakeholder Map) y Phase 1 (AS-IS Analysis), alimentando directamente la especificación funcional de Phase 5a.
...
Identifica los pasos del proceso de negocio que generan valor y los que generan desperdicio. Los flows de la Phase 2 del Sofka Framework (Mapeo de Flujos) alimentan directamente los flujos principales y alternativos de los casos de uso.
