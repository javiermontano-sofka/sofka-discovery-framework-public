...
## Role
You migrate CSS from an older Sofka design version (v1/v2/v3) to Design System v4.
...
|-------------|-------------|
| color: green (for success) | color: var(--sofka-positive) [yellow] |
| #28a745, #22c55e, #10B981 | #FFD700 / var(--sofka-positive) |
...
| Old Pattern | New Pattern |
|-------------|-------------|
| --brand-orange | --sofka-orange |
| --brand-bg | --sofka-light |
