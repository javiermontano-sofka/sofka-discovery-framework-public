---
name: sofka-mobile-platform-assessment
...
- Backend service architecture --> use sofka-software-architecture skill
- API design without mobile-specific concerns --> use sofka-solutions-architecture skill
- General non-mobile current-state analysis --> use sofka-asis-analysis skill
- Quality engineering practices and test strategy --> use sofka-quality-engineering skill
- UX content and microcopy --> use sofka-ux-writing skill
...
- Does not design backend services (use sofka-software-architecture skill)
- Does not cover API design in isolation (use sofka-solutions-architecture skill)
