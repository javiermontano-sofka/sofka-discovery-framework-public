# Sofka RPA Methodology — Reference

## Foundations

La metodologia de RPA de Sofka se fundamenta en la interseccion de cuatro marcos de trabajo complementarios:
...
### RPA Factory
- Equipo dedicado Sofka que opera como fabrica de bots
