...
### Slide 1: Portada
- Logo Sofka (esquina superior derecha)
...
- Línea actual (naranja #FF7E08) vs target (amarillo #FFD700)
...
| **Primary color** | #FF7E08 |
| **Dark background** | #1A1A2E |
| **Success indicator** | #FFD700 (NUNCA verde) |
...
El equipo de delivery usa esta spec + una plantilla .pptx de Sofka para producir la presentación final.
