...
**Escenario:** Sofka realiza due diligence técnica para un proceso de M&A. El pitch presenta hallazgos y recomendaciones de integración/remediación al board del adquirente.
...
4. **Iteration:** Usar `/sdf:discovery-improve` post-pitch para refinar con feedback del cliente.
