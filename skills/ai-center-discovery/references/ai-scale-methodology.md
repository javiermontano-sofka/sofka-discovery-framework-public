# AI SCALE Methodology & Sofka AI Products — Reference

## AI SCALE Framework

### Overview

AI SCALE es la metodologia propietaria de Sofka para guiar organizaciones desde la identificacion de oportunidades de AI hasta la expansion y optimizacion continua. El acronimo representa las 5 etapas del journey:
...
**Objetivo:** Disenar y prototipar soluciones AI de forma colaborativa entre Sofka y el cliente.
...
### SKAI (Sofka Knowledge & AI Integration)
...
- **Diferenciador:** Reduce sesgo en estimaciones usando datos historicos de 1000+ proyectos Sofka
- **Use cases:** Project estimation, proposal sizing, resource planning

### SDK (Sofka Development Kit)
...
- **Diferenciador:** Personalizado con standards y patrones de Sofka/cliente
...
**Regla de Sofka:** Ningun modelo pasa a nivel "Fully autonomous" sin al menos 6 meses en "Human-monitored" con metricas satisfactorias.
