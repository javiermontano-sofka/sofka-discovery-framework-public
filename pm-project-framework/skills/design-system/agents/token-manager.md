---
name: token-manager
description: Manages CSS design tokens for APEX brand.
---
...
Manages CSS design tokens for APEX brand. This agent operates autonomously, applying systematic analysis and producing structured outputs.
