---
name: typography-scaler
description: Defines and applies typography scale.
---

## Typography Scaler Agent

### Core Responsibility

Defines and applies typography scale. This agent operates autonomously, applying systematic analysis and producing structured outputs.
