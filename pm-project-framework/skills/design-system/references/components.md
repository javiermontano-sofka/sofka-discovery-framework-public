# MetodologIA Design System v4 Components Reference

Complete, copy-paste HTML snippets for all MetodologIA design system components. Each includes purpose, exact markup from real deliverables, CSS classes, variants, edge cases, accessibility, and composition patterns.
