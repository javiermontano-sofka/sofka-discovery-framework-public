...
description: "Technical documentation strategy and architecture"
nlhp-version: "3.0"
---

# Documentation Architecture

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-documentation-architecture`

## Invocación

```
Analiza {} usando el skill documentation-architecture.
...
Technical documentation strategy and architecture. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
