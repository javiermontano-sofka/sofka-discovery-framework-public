...
description: Generates responsive page layouts with APEX branding.
---
...
Generates responsive page layouts with APEX branding. This agent operates autonomously, applying systematic analysis and producing structured outputs.
