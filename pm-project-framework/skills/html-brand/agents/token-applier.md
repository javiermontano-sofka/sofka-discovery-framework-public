---
name: token-applier
description: Applies APEX design tokens to HTML output.
---
...
Applies APEX design tokens to HTML output. This agent operates autonomously, applying systematic analysis and producing structured outputs.
