...
description: "Incident response design and MTTR optimization"
nlhp-version: "3.0"
---

# Incident Management

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-incident-management`

## Invocación

```
Analiza {} usando el skill incident-management.
...
Incident response design and MTTR optimization. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
