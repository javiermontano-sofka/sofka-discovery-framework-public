...
description: Generates Mermaid Gantt charts from schedule data.
---

## Gantt Chart Generator Agent

### Core Responsibility

Generates Mermaid Gantt charts from schedule data. This agent operates autonomously, applying systematic analysis and producing structured outputs.
