...
description: Creates C4 architecture diagrams using Mermaid syntax.
---
...
Creates C4 architecture diagrams using Mermaid syntax. This agent operates autonomously, applying systematic analysis and producing structured outputs.
