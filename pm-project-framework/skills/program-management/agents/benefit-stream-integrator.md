---
name: benefit-stream-integrator
description: Integrates benefit realization across projects ensuring program-level benefits exceed sum of project benefits.
---
