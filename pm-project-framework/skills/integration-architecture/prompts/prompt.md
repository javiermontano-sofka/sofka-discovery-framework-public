...
description: "Integration patterns, ESB/iPaaS, and API gateway design"
nlhp-version: "3.0"
---

# Integration Architecture

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-integration-architecture`

## Invocación

```
Analiza {} usando el skill integration-architecture.
...
Integration patterns, ESB/iPaaS, and API gateway design. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
