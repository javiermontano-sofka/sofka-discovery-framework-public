...
description: "Green IT assessment and carbon footprint reduction"
nlhp-version: "3.0"
---

# Sustainability Assessment

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-sustainability-assessment`

## Invocación

```
Analiza {} usando el skill sustainability-assessment.
...
Green IT assessment and carbon footprint reduction. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
