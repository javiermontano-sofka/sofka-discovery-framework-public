...
description: "Workshop design for event storming, impact mapping"
nlhp-version: "3.0"
---

# Workshop Facilitator

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-workshop-facilitator`

## Invocación

```
Analiza {} usando el skill workshop-facilitator.
...
Workshop design for event storming, impact mapping. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
