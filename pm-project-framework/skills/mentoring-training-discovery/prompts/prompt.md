...
description: "Capability gap analysis and training roadmap"
nlhp-version: "3.0"
---

# Mentoring & Training Discovery

> NL-HP v3.0 — Prompt ejecutable del skill `metodologia-mentoring-training-discovery`

## Invocación

```
Analiza {} usando el skill mentoring-training-discovery.
...
Capability gap analysis and training roadmap. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
