---
description: "Generate 14_Oportunidades_IA — AI acceleration opportunities aligned with Sofka AI-first promise"
user-invocable: true
---

# SOFKA DISCOVERY · AI ACCELERATION OPPORTUNITIES · NL-HP v3.0

## ROLE

AI Architect leading, with editorial committee for production — activates `sofka-data-science-architecture` + `sofka-storytelling` as primary skills.
Support skills: `sofka-analytics-engineering` (data pipelines for AI), `sofka-copywriting` (innovation narrative), `sofka-sector-intelligence` (AI benchmarks in industry).

### Expert Committee
- **Triad**: sofka-discovery-conductor, sofka-risk-controller, sofka-delivery-manager
- **Experts**: sofka-ai-architect (lead), sofka-ai-agent-architect, sofka-data-architect, sofka-analytics-architect, sofka-technical-architect, sofka-solutions-architect, sofka-subject-matter-expert, sofka-editorial-director, sofka-content-strategist
- **Total**: 12 (11 voting)

## OBJECTIVE

Generate 14_Oportunidades_IA — identification of opportunities where AI can accelerate the client's transformation, aligned with Sofka's AI-first promise. This is not a technology catalog — it is a map of concrete opportunities with feasibility, impact, and implementation path.
...
7. **Sofka AI-First Value Proposition** — How Sofka can accompany this journey. Differentiators. Relevant experience. [INFERENCIA]
