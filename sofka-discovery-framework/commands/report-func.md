...
# SOFKA DISCOVERY · FUNCTIONAL FINDINGS · NL-HP v3.0

## ROLE

Domain Analyst leading, with editorial committee for production — activates `sofka-flow-mapping` + `sofka-functional-spec` + `sofka-storytelling` as primary skills.
Support skills: `sofka-user-representative` (user voice), `sofka-ux-writing` (accessibility), `sofka-data-storytelling` (functional metrics).

### Expert Committee
- **Triad**: sofka-discovery-conductor, sofka-risk-controller, sofka-delivery-manager
- **Experts**: sofka-domain-analyst (lead), sofka-business-analyst, sofka-ux-strategist, sofka-ux-researcher, sofka-frontend-developer, sofka-quality-guardian, sofka-subject-matter-expert, sofka-editorial-director
