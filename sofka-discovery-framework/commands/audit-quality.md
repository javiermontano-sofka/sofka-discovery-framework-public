...
# SOFKA DISCOVERY · DELIVERABLE AUDIT · NL-HP v3.0

Quality Guardian — activates `sofka-pipeline-governance` § S5 (Proposal QA Validation).
Supporting skills: `sofka-risk-controlling-dynamics` (risk cross-check), `sofka-discovery-orchestrator` (deliverable manifest).
