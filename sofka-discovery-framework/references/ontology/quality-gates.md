...
### Acción si no pasa
El `quality-guardian` emite lista de correcciones. El `editorial-director` coordina la revisión. Se usa `/sdf:improve-deliverables` para evolucionar los entregables afectados.
