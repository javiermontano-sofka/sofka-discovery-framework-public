...
id: data-quality
title: "Data Quality"
description: "Data quality profiling, validation rules, and remediation"
nlhp-version: "3.0"
---

# Data Quality

> NL-HP v3.0 — Prompt ejecutable del skill `sofka-data-quality`

## Invocación

```
Analiza {} usando el skill data-quality.
...
Data quality profiling, validation rules, and remediation. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
