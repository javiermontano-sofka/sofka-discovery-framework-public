...
> Ready-to-use prompts that activate the `sofka-architecture-tobe` skill in the most frequent target architecture design scenarios.
...
**Prompt:**
```
/sdf:architecture-tobe {SISTEMA} {VARIANTE}=ejecutiva {FORMATO}=html
...
Genera el ADR con el formato estándar Sofka: Contexto, Decisión, Alternativas con pros/cons, Trade-off, y Consecuencias.
```
...
**Prompt:**
```
/sdf:architecture-tobe {SISTEMA_BANCARIO}
