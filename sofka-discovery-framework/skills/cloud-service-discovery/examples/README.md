# Cloud Service Discovery — Example Outputs

Sample outputs demonstrating what the cloud-service-discovery skill produces for a fictional "Acme Corp Banking Modernization" project.
