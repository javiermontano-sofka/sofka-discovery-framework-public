...
| **Conditional formatting** | 🔴 Critical/High, 🟡 Medium, 🟢 Low (usar #FFD700 para success, NO verde) |
...
2. Esta spec para que el equipo de delivery use una plantilla Excel de Sofka
