...
| `sample-output.html` | Conversión HTML del mismo deliverable con Sofka Design System v4 completo — hero, sticky nav, scenario cards, gate card, ghost menu visual, Mermaid CDN v10 |
...
- `sample-output.html` es la referencia para conversión HTML: brand compliance (#FF7E08 primario, #1A1A2E oscuro, #FFD700 gold para positivo, nunca verde), accesibilidad WCAG AA, print styles, y Mermaid rendering.
...
- Success/positive states usan gold (#FFD700), nunca verde — compliance Sofka obligatorio.
