# Especificacion de Plantilla XLSX — Sofka Technologies

> Referencia definitiva para la produccion de hojas de calculo XLSX con branding Sofka.
...
```
A1: "SOFKA."                    ← Clash Grotesk Bold 16pt, #1A1A2E, merge A1:B1
C1: {Nombre del Proyecto}       ← Inter Bold 14pt, #FF7E08, merge C1:F1
...
A5: [Linea separadora]         ← Borde inferior en fila 4: 2pt #FF7E08
```
...
|-----------|-------------|-------------|-------|
| Score 8-10 | #FFD700 | #1A1A2E | 1pt #B8860B |
...
| Contiene "Baja" o "Controlado" | #FFD700 | #1A1A2E |
| Contiene "Aprobado" | #FFD700 | #1A1A2E |
| Contiene "Rechazado" | #FEE2E2 | #EF4444 |
| Contiene "Pendiente" | #FEF3C7 | #B45309 |

**Regla critica:** NUNCA usar verde (#00XX00) para estados positivos. El sistema Sofka usa gold (#FFD700).
...
|----------|-------|-----|-----|
| 1 | Naranja Sofka | #FF7E08 | Serie principal |
| 2 | Negro Sofka | #1A1A2E | Serie secundaria |
| 3 | Gold | #FFD700 | Positivo/exito |
...
```
"(c) Sofka Technologies | {FECHA} | Confidencial"
...
| Autor | Sofka Technologies |
| Compania | Sofka Technologies |
