...
> CLI interactivo de inicialización para Sofka SAGE.
...
| **HTML** | Self-contained con tokens canónicos Sofka. Reporte de inicialización con status badges. WCAG AA. |
| **DOCX** | python-docx. Heading 1 = Inter 700 #FF7E08. Tabla de configuración del cliente. Header Sofka. |
| **XLSX** | openpyxl. Hoja "Init Config" con columnas: Parameter, Value, Status. Header naranja #FF7E08. |
| **PPTX** | python-pptx. 5 slides: Banner, Client Info, Service Type, G0 Status, Next Steps. Slide master naranja. |
...
|--------|-----------|----------|
| `sdf-init.sh` | `scripts/sdf-init.sh` | Wizard interactivo de inicialización |
