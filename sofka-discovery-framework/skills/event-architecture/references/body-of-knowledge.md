...
skill: sofka-event-architecture
...
|---|---|---|
| **API Architecture** | AsyncAPI, webhooks, event-driven API surfaces | `sofka-api-architecture` |
| **Software Architecture** | DDD bounded contexts, aggregate design, module boundaries | `sofka-software-architecture` |
| **Data Engineering** | CDC pipelines, stream processing, data lake ingestion | `sofka-data-engineering` |
| **Infrastructure Architecture** | Broker provisioning, cluster sizing, networking | `sofka-infrastructure-architecture` |
| **Security Architecture** | Event encryption, ACLs, audit trail compliance | `sofka-security-architecture` |
| **DevSecOps Architecture** | Schema validation en CI/CD, contract tests, deployment gates | `sofka-devsecops-architecture` |
| **Performance Engineering** | Consumer lag optimization, throughput tuning, latency budgets | `sofka-performance-engineering` |
| **Observability** | Distributed tracing, consumer metrics, DLQ dashboards | `sofka-observability` |
