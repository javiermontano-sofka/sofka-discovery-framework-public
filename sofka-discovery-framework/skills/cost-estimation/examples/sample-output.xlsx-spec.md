...
- Columna I: valores > promedio + 1 desviacion estandar en negrita + fondo #FFD700.
...
**Formato condicional:**
- Columna C: Junior = fondo claro, Senior = fondo #FFD700, Principal = fondo #FF7E08 con texto blanco.
...
**Formato condicional:**
- Columna D: <25% fondo #E8F5E9, 25-50% fondo #FFF3E0, 50-75% fondo #FFD700, >75% fondo #FFEBEE.
...
**Formato condicional:**
- Columna F (P80): fondo #FFD700 — es el valor recomendado para planificacion.
...
**Formato condicional:**
- Columnas C, E, G (magnitud): Bajo = fondo #E8F5E9, Medio = fondo #FFF3E0, Alto = fondo #FFD700, Critico = fondo #FFEBEE.
- Menor magnitud por fila resaltada con borde #FF7E08 (opcion mas favorable).
