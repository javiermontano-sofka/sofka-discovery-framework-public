...
description: "IT governance design aligned to COBIT/ITIL"
nlhp-version: "3.0"
---

# Governance Framework

> NL-HP v3.0 — Prompt ejecutable del skill `sofka-governance-framework`

## Invocación

```
Analiza {} usando el skill governance-framework.
...
IT governance design aligned to COBIT/ITIL. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
