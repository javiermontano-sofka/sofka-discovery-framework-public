...
skill: sofka-api-architecture
author: Javier Montaño
organization: Sofka Technologies
version: 1.0.0
updated: 2026-03-13
---
...
**Richardson Maturity Model** — evalúa el grado de madurez REST de 0 (POX) a 3 (HATEOAS). El nivel 2 (HTTP Verbs) es el mínimo aceptable para APIs de producción en Sofka.
...
|---|---|---|
| **Event Architecture** | AsyncAPI, webhooks, event-driven APIs, CloudEvents | `sofka-event-architecture` |
| **Security Architecture** | OAuth 2.0, mTLS, WAF, OWASP API Security Top 10 | `sofka-security-architecture` |
| **Software Architecture** | Domain boundaries, service contracts, DDD bounded contexts | `sofka-software-architecture` |
| **Infrastructure Architecture** | API Gateway provisioning, rate limiting infra, CDN | `sofka-infrastructure-architecture` |
| **DevSecOps Architecture** | Linting en CI/CD, contract tests, schema diff gates | `sofka-devsecops-architecture` |
| **Performance Engineering** | Latency budgets, rate limiting overhead (<5ms p99), load testing | `sofka-performance-engineering` |
| **Solutions Architecture** | APIs como contratos de integración entre sistemas | `sofka-solutions-architecture` |
