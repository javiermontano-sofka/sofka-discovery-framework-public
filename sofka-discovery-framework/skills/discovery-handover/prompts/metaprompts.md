...
**Propósito:** Al terminar una fase de ejecución, generar un prompt para crear un post-mortem del handover que documente aprendizajes, ajuste la metodología de discovery, y alimente el repositorio de conocimiento de Sofka.

**Template:**
```
Eres un knowledge manager y metodólogo de discovery con responsabilidad de mejorar continuamente el Sofka Discovery Framework basado en la experiencia de proyectos reales.
...
- Qué ajustar en la metodología del Sofka Framework para el próximo engagement

Formato output: documento de aprendizajes estructurado + lista de mejoras propuestas al Sofka Discovery Framework.
```

**Guía de uso:**
- Ejecutar al completar la fase Foundation (90 días) o al activar un kill criterion
- El output alimenta el repositorio de lecciones aprendidas del equipo de PreSales Sofka
