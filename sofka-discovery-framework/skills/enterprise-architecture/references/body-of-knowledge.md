...
skill: sofka-enterprise-architecture
author: Javier Montaño
brand: Sofka Technologies ©
updated: 2026-03-13
---

# Body of Knowledge: Arquitectura Enterprise

> Corpus de conocimiento estructurado para la práctica de Arquitectura Enterprise en Sofka Technologies. Cubre fundamentos teóricos, marcos de referencia, obras seminales, metodologías, herramientas y conexiones con otras disciplinas.
...
**Aplicación en Sofka**: TOGAF se usa como vocabulario y estructura conceptual, no como proceso burocrático. Se extraen las herramientas relevantes (capability catalog, architecture roadmap, gap analysis) sin implementar todas las fases.
...
| Mermaid / PlantUML | Diagramas en código | Uso en Sofka; integración en markdown |
...
|-----------|----------|-----------|
| **sofka-solutions-architecture** | Recibe capability map y domain model; diseña soluciones dentro de los bounded contexts | EA → SA |
| **sofka-software-architecture** | Recibe estándares tecnológicos del radar y patrones del ARB | EA → SwA |
| **sofka-infrastructure-architecture** | Implementa recomendaciones del operating model y radar para plataformas | EA → IA |
| **sofka-devsecops-architecture** | Aplica controles de cumplimiento y estándares de gobierno en pipelines | EA → DevSecOps |
| **sofka-data-governance** | La arquitectura de datos enterprise emana del domain model DDD | EA → DG |
...
*© Sofka Technologies — Autor: Javier Montaño — Uso interno y con clientes*
