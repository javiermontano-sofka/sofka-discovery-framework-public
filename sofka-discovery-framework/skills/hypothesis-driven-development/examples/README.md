...
| `sample-output.html` | HTML | Branded version (Sofka Design System: Primary #FF7E08, Dark #1A1A2E, Success #FFD700). Hypothesis cards with status badges, threshold bars, and Mermaid CDN v10 diagrams |
