...
description: "Migration execution waves, cutover strategy, and rollback design"
nlhp-version: "3.0"
---

# Migration Playbook

> NL-HP v3.0 — Prompt ejecutable del skill `sofka-migration-playbook`

## Invocación

```
Analiza {} usando el skill migration-playbook.
...
Migration execution waves, cutover strategy, and rollback design. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
