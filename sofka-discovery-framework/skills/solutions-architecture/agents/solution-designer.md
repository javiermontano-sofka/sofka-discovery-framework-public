...
- Solution design depends on internal architecture decisions (from **sofka-software-architecture**)
- Physical deployment constraints come from infrastructure design (from **sofka-infrastructure-architecture**)
