...
flowchart TD
    ...
    classDef primary fill:#FF7E08,stroke:#1A1A2E,color:#fff
    classDef risk fill:#DC3545,stroke:#1A1A2E,color:#fff
    classDef success fill:#FFD700,stroke:#1A1A2E,color:#1A1A2E
...
| Brand colors correct | Orange #FF7E08, gold #FFD700 para success, red #DC3545 para riesgo. Cero uso de verde |
| Visual sequence builds argument | Problema (C4) → Evidencia (pie) → Impacto (sequence) → Scoring (quadrant) → Acción (roadmap) |

---

*Fuente: data-viz-storytelling skill — Sofka Discovery Framework*
