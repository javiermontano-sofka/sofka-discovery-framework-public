...
description: "Technical debt inventory, interest rate, and remediation plan"
nlhp-version: "3.0"
---

# Tech Debt Assessment

> NL-HP v3.0 — Prompt ejecutable del skill `sofka-tech-debt-assessment`

## Invocación

```
Analiza {} usando el skill tech-debt-assessment.
...
Technical debt inventory, interest rate, and remediation plan. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
