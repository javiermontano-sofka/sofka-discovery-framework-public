---
name: sofka-cross-platform-convert
description: Cross-platform skill converter that transforms SAGE MOAT skills into formats compatible with Cursor, Codex CLI, Gemini CLI, Aider, and Windsurf. Use when the user asks to convert skills, export for other tools, make skills cross-platform, or distribute skills to non-Claude tools. Triggered by "convert skills", "export for cursor", "cross-platform", "convert to codex".
...
# sofka-cross-platform-convert

> Converts SAGE MOAT skills to formats compatible with 5+ AI coding platforms.
> Expands SAGE's reach beyond Claude Code without sacrificing MOAT quality.
