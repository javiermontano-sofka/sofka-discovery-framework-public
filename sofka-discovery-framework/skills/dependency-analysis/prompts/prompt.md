...
description: "System dependency mapping and coupling analysis"
nlhp-version: "3.0"
---

# Dependency Analysis

> NL-HP v3.0 — Prompt ejecutable del skill `sofka-dependency-analysis`

## Invocación

```
Analiza {} usando el skill dependency-analysis.
...
System dependency mapping and coupling analysis. Sigue el protocolo NL-HP v3.0 con evidence tagging obligatorio.
