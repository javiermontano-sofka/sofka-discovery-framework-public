...
| `sample-output.html` | HTML Branded | Mismo reporte en formato visual Sofka (dashboard-style) | Referencia para `{FORMATO}=html` |
...
- **Modelo Sofka:** 1 FTE = 1 feature/dia (desde Sprint 2), ramp-up Sprint 1 = 0.5x

### HTML (`sample-output.html`)

- **Design System Sofka v4:** Primary #FF7E08, Dark #1A1A2E, Success #FFD700
