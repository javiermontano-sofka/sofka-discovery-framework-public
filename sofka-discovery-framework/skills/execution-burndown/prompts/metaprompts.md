...
2. **Curva de Ramp-Up Real vs. Modelo:**
   | Dia | Modelo Sofka | Developer A | Developer B | Developer C | Developer D | Promedio Real |
   |-----|-------------|-------------|-------------|-------------|-------------|---------------|
   | 1   | 0.50x       | ?           | ?           | ?           | ?           | ?             |
   | 2   | 0.75x       | ?           | ?           | ?           | ?           | ?             |
   | 3   | 1.00x       | ?           | ?           | ?           | ?           | ?             |
