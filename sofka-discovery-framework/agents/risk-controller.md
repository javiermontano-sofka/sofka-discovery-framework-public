...
| Skill | Function |
|---|---|
| `sofka-risk-controlling-dynamics` | Risk quantification, cascade analysis, pre-mortem, stress testing, financial controls, assumption validation |
| `sofka-functional-spec` | Acceptance criteria validation, functional requirements completeness, use case coverage |
| `sofka-quality-engineering` | Code quality metrics assessment, test strategy validation, coverage analysis |
