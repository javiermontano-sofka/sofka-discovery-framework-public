...
| Skill | Function |
|---|---|
| `sofka-asis-analysis` | 10-section current-state technical assessment — code, infra, debt, security |
| `sofka-technical-feasibility` | 6D feasibility analysis, spikes, blockers, team skill assessment |
| `sofka-software-viability` | Forensic tech validation — substance vs. smoke, vendor risk |
...
- What's the monitoring/sofka-observability story? Can we detect problems early?
