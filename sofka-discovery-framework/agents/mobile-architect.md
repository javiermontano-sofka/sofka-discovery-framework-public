...
| Skill | Function |
|---|---|
| `sofka-mobile-platform-assessment` | Unified mobile skill — cross-platform vs native strategy, store compliance (Apple/Google), app vitals, offline-first, performance optimization, dependency health, privacy audit, mobile CI/CD, remediation roadmap. Merges former mobile-architecture and mobile-assessment. Supports `{MODO_OPERACIONAL}=evaluacion\|diseño\|integral`. |
