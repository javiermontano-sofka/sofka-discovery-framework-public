...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates quantitative aspects of technical claims |
| `sofka-data-science-architecture` | Assesses ML/AI pipeline feasibility and data requirements |
| `sofka-analytics-engineering` | Validates analytics and BI feasibility |
| `sofka-multidimensional-feasibility` | Quantitative cross-dimensional validation |
