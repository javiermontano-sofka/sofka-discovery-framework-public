...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates infrastructure assumptions against physical limits |
| `sofka-infrastructure-architecture` | Assesses infrastructure design feasibility |
| `sofka-cloud-native-architecture` | Validates cloud scaling assumptions |
| `sofka-performance-engineering` | Validates performance claims against hardware reality |
| `sofka-multidimensional-feasibility` | Infrastructure cross-dimensional validation |
