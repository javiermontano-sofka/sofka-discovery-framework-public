...
| Skill | Function |
|---|---|
| `sofka-enterprise-architecture` | Portfolio assessment, TOGAF layers, capability map, strategic alignment, governance model |
| `sofka-architecture-tobe` | Target state design, migration path, transition architecture, gap analysis AS-IS → TO-BE |
