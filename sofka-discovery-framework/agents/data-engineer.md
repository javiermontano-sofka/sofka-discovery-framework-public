...
| Skill | Function |
|---|---|
| `sofka-data-engineering` | ETL/ELT pipeline architecture, orchestration (Airflow/Dagster), data quality in transit, idempotency, data contracts |
| `sofka-database-architecture` | Schema design, indexing strategy, sharding/partitioning, replication, zero-downtime migrations |
| `sofka-data-governance` | Data catalog, lineage, classification, compliance (GDPR/CCPA), retention policies, ownership model. **Includes data-quality as a dimension** (accuracy, completeness, consistency, timeliness, uniqueness, validity) |
...
| **Skills** | sofka-data-engineering, sofka-database-architecture, sofka-data-governance | sofka-analytics-engineering, sofka-bi-architecture, sofka-data-science-architecture |
