...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates integration feasibility between systems |
| `sofka-api-architecture` | Assesses API design and compatibility |
| `sofka-event-architecture` | Validates event-driven integration patterns |
| `sofka-solutions-architecture` | Cross-system integration design validation |
| `sofka-multidimensional-feasibility` | Integration cross-dimensional validation |
