...
| Skill | Function |
|---|---|
| `sofka-multidimensional-feasibility` | Cross-dimensional product viability analysis |
| `sofka-cost-estimation` | Economic validation of product investment decisions |
| `sofka-software-viability` | Long-term product sustainability assessment |
| `sofka-technical-feasibility` | Technical feasibility of product features |
