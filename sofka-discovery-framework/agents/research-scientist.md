...
| Skill | Function |
|---|---|
| `sofka-technical-feasibility` | Validates technical claims against evidence base |
| `sofka-software-viability` | Assesses software solution viability with academic rigor |
| `sofka-multidimensional-feasibility` | Cross-dimensional feasibility through evidence lens |
