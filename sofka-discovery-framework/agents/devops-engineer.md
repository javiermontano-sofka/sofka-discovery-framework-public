...
| Skill | Function |
|---|---|
| `sofka-devsecops-architecture` | CI/CD pipeline design, security scanning integration, deployment automation |
| `sofka-asis-analysis` | CI/CD maturity assessment, DORA metrics evaluation, pipeline health analysis |
| `sofka-quality-engineering` | Quality gates in CI/CD, automated testing integration, build reliability |
| `sofka-observability` | Deployment monitoring, deployment tracking, release health dashboards |
| `sofka-infrastructure-architecture` | IaC pipeline integration, environment provisioning automation |
