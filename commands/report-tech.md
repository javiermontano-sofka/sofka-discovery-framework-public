...
# SOFKA DISCOVERY · TECHNICAL FINDINGS · NL-HP v3.0

## ROLE

Technical Architect leading, with editorial committee for production — activates `sofka-asis-analysis` + `sofka-software-architecture` + `sofka-technical-writing` as primary skills.
Support skills: `sofka-data-storytelling` (technical metrics to meaning), `sofka-security-architecture`, `sofka-observability`, `sofka-testing-strategy`.

### Expert Committee
- **Triad**: sofka-discovery-conductor, sofka-risk-controller, sofka-delivery-manager
- **Experts**: sofka-technical-architect (lead), sofka-technical-lead, sofka-implementation-analyst, sofka-backend-developer, sofka-frontend-developer, sofka-security-architect, sofka-quality-engineer, sofka-devops-engineer, sofka-editorial-director
- **Total**: 12 (11 voting)
...
4. **Infrastructure and Operations** — CI/CD state, sofka-observability, resilience, deployment patterns. DORA metrics if available. [CONFIG][DOC]
