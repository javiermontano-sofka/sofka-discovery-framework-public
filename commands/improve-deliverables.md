...
# SOFKA DISCOVERY · DELIVERABLE EVOLUTION · NL-HP v3.0

Full expert panel — activates `sofka-discovery-orchestrator` as coordinating skill.
Each deliverable evolves using its primary skill: 02/03->sofka-asis-analysis, 04->sofka-flow-mapping, 05->sofka-scenario-analysis, 06->sofka-solution-roadmap+sofka-cost-estimation, 07->sofka-functional-spec, 08->sofka-executive-pitch, 09->sofka-discovery-handover.
