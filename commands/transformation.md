...
# SOFKA DISCOVERY · TRANSFORMACIÓN DIGITAL · NL-HP v3.0
...
## OBJETIVO
Ejecutar discovery completo para programas de transformación digital multi-servicio. Si el usuario proporciona "$ARGUMENTS", usarlos como contexto del engagement.

## PROTOCOLO

### CP-0 · Ingesta
1. Recolecta: estrategia digital, estructura organizacional, portafolio de servicios actual, roadmap existente.
2. NO requiere código fuente — la fuente de verdad es la estrategia y la organización.
3. Clasifica: iniciativas en curso, workstreams propuestos, stakeholders clave, presupuesto disponible.
4. Declara gaps. Si no hay sponsorship ejecutivo → flag como riesgo CRÍTICO.

### CP-1 · Ejecución
1. **Digital Maturity Assessment** — 6 dimensiones (strategy, technology, data, process, people, customer) levels 1-5.
2. **Service Portfolio Mapping** — mapeo de necesidades del cliente a líneas de servicio Sofka (SDA, QA, Cloud, Data-AI, RPA, Management, SAS, UX).
3. **Program Architecture** — patrón de programa (sequential waves / parallel tracks / value stream aligned / platform + consumers).
4. **Cross-Workstream Dependencies** — hard/soft/data/governance/people dependencies con owners.
5. **Change Readiness** — evaluación de preparación organizacional, resistencia, champions.
...
### CP-F · Validación
- [ ] Digital maturity baseline con score por dimensión
- [ ] Service portfolio mapping completo (≥3 service lines)
...
- Programas de transformación requieren ≥2 líneas de servicio; si es mono-servicio → redirect a discovery específico.
