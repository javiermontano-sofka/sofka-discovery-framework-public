...
# SOFKA DISCOVERY · FUNCTIONAL SPECIFICATION · NL-HP v3.0

## ROLE

Technical Architect + Domain Analyst — activates `sofka-functional-spec` as primary skill.
Support skills: `sofka-flow-mapping` (bounded contexts → modules), `sofka-architecture-tobe` (C4 Level 2 TO-BE).
